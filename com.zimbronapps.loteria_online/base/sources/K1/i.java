...
public class i extends m {
    ...
    public Typeface a(Context context, e.c cVar, Resources resources, int i) {
        ...
        for (e.d dVar : cVar.a()) {
            ByteBuffer b2 = n.b(context, resources, dVar.b());
            if (b2 == null || !i(l, b2, dVar.c(), dVar.e(), dVar.f())) {
                return null;
            }
        }
        return j(l);
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, l.b[] bVarArr, int i) {
        ...
        for (l.b bVar : bVarArr) {
            Uri d2 = bVar.d();
            ByteBuffer byteBuffer = (ByteBuffer) i0Var.get(d2);
            if (byteBuffer == null) {
                byteBuffer = n.f(context, cancellationSignal, d2);
                i0Var.put(d2, byteBuffer);
            }
            if (byteBuffer == null || !i(l, byteBuffer, bVar.c(), bVar.e(), bVar.f())) {
                return null;
            }
        }
        Typeface j = j(l);
