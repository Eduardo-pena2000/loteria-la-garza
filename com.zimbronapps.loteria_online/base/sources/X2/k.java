...
public abstract class k {
    ...
    public static abstract class a extends k {
        ...
        public final long j(long j) {
            List list = this.f;
            return K.X0(list != null ? ((d) list.get((int) (j - this.d))).a - this.c : (j - this.d) * this.e, 1000000L, this.b);
        }
    ...
    public static final class c extends a {
        ...
        public i a(j jVar) {
            ...
            q qVar = jVar.b;
            return new i(nVar.a(qVar.a, 0L, qVar.i, 0L), 0L, -1L);
        }
        ...
        public long g(long j) {
            ...
            if (j != -9223372036854775807L) {
                return v7.a.a(BigInteger.valueOf(j).multiply(BigInteger.valueOf(this.b)), BigInteger.valueOf(this.e).multiply(BigInteger.valueOf(1000000L)), RoundingMode.CEILING).longValue();
            }
            return -1L;
        }
        ...
        public i k(j jVar, long j) {
            ...
            n nVar = this.k;
            q qVar = jVar.b;
            return new i(nVar.a(qVar.a, j, qVar.i, j2), 0L, -1L);
        }
    }
    ...
    public long b() {
        return K.X0(this.c, 1000000L, this.b);
    }
