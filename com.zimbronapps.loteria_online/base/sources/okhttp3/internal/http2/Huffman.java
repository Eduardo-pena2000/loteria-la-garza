...
public final class Huffman {
    ...
    public final void a(int i, int i2, int i3) {
        ...
        Node[] a3 = node2.a();
        t.d(a3);
        p.u(a3, node, i6, (1 << i5) + i6);
    }

    public final void b(g source, long j, f sink) {
        t.g(source, "source");
        t.g(sink, "sink");
        Node node = d;
        int i = 0;
        ...
        while (j2 < j) {
            j2++;
            i = (i << 8) | Util.d(source.readByte(), 255);
            i2 += 8;
            while (i2 >= 8) {
                Node[] a2 = node.a();
                t.d(a2);
