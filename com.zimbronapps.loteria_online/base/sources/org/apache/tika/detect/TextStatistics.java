...
public class TextStatistics {
    ...
    public boolean isMostlyAscii() {
        ...
        int i = this.total;
        return i > 0 && (count - countSafeControl) * 100 < i * 2 && (count2 + countSafeControl) * 100 > i * 90;
    }
    ...
    public boolean looksLikeUTF8() {
        ...
        return count2 > 0 && count3 <= i2 && count3 >= i2 - 3 && count(248, 256) == 0 && (count - countSafeControl) * 100 < count2 * 2;
    }
