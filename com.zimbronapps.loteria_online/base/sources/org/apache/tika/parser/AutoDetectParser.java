...
public class AutoDetectParser extends CompositeParser {
    ...
    public void parse(InputStream inputStream, ContentHandler contentHandler, Metadata metadata, ParseContext parseContext) throws IOException, SAXException, TikaException {
        ...
        try {
            ...
            maybeSpool(inputStream2, this.autoDetectParserConfig, metadata);
            MediaType detect = this.detector.detect(inputStream2, metadata);
            ...
            if (inputStream2.getOpenContainer() == null && this.autoDetectParserConfig.getThrowOnZeroBytes()) {
                inputStream2.mark(1);
            ...
            SecureContentHandler createSecureContentHandler = decorateHandler != null ? createSecureContentHandler(decorateHandler, inputStream2, this.autoDetectParserConfig) : null;
            initializeEmbeddedDocumentExtractor(metadata, parseContext);
            try {
                super.parse(inputStream2, createSecureContentHandler, metadata, parseContext);
                temporaryResources.dispose();
            } catch (SAXException e) {
                createSecureContentHandler.throwIfCauseOf(e);
                throw e;
            }
        } catch (Throwable th) {
            temporaryResources.dispose();
