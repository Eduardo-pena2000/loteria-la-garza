...
public class AutoDetectParserFactory extends ParserFactory {
    ...
    public AutoDetectParserFactory(Map map) {
        super(map);
    }
    ...
    */
    public org.apache.tika.parser.Parser build() throws java.io.IOException, org.xml.sax.SAXException, org.apache.tika.exception.TikaException {
        /*
            r3 = this;
            java.util.Map r0 = r3.args
            ...
            java.nio.file.Path r2 = com.applovin.shadow.okio.F.a(r0, r2)
            ...
            java.nio.file.Path r0 = com.applovin.shadow.okio.F.a(r0, r1)
            r2.<init>(r0)
            goto L4f
        L25:
