...
public class CharsetUtils {
    ...
    static {
        ...
        if (cls != null) {
            try {
                getCharsetICU = cls.getMethod("forNameICU", new Class[]{String.class});
                try {
                    isSupportedICU = cls.getMethod("isSupported", new Class[]{String.class});
    ...
    public static Charset forName(String str) {
        ...
        Map map = COMMON_CHARSETS;
        Charset charset = (Charset) map.get(lowerCase);
        if (charset != null) {
            return charset;
        }
        ...
        if (method != null) {
            try {
                Charset charset2 = (Charset) method.invoke((Object) null, new Object[]{group});
                if (charset2 != null) {
                    return charset2;
                }
            } catch (IllegalArgumentException | IllegalAccessException | InvocationTargetException unused) {
            }
        }
        return Charset.forName(group);
    }

    private static Map initCommonCharsets(String... strArr) {
        HashMap hashMap = new HashMap();
        for (String str : strArr) {
            try {
                Charset forName = Charset.forName(str);
                COMMON_CHARSETS.put(str.toLowerCase(Locale.ENGLISH), forName);
                Iterator it = forName.aliases().iterator();
                while (it.hasNext()) {
                    COMMON_CHARSETS.put(((String) it.next()).toLowerCase(Locale.ENGLISH), forName);
                }
            } catch (IllegalArgumentException unused) {
            }
        }
    ...
    public static boolean isSupported(String str) {
        try {
            ...
            if (method == null || !((Boolean) method.invoke((Object) null, new Object[]{str})).booleanValue()) {
