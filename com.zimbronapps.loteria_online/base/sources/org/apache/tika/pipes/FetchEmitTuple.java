...
public class FetchEmitTuple implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.id, fetchEmitTuple.id) && Objects.equals(this.fetchKey, fetchEmitTuple.fetchKey) && Objects.equals(this.emitKey, fetchEmitTuple.emitKey) && Objects.equals(this.metadata, fetchEmitTuple.metadata) && Objects.equals(this.parseContext, fetchEmitTuple.parseContext) && this.onParseException == fetchEmitTuple.onParseException && Objects.equals(this.embeddedDocumentBytesConfig, fetchEmitTuple.embeddedDocumentBytesConfig);
    }
    ...
    public String toString() {
        return "FetchEmitTuple{id='" + this.id + "', fetchKey=" + String.valueOf(this.fetchKey) + ", emitKey=" + String.valueOf(this.emitKey) + ", metadata=" + String.valueOf(this.metadata) + ", parseContext=" + String.valueOf(this.parseContext) + ", onParseException=" + String.valueOf(this.onParseException) + ", embeddedDocumentBytesConfig=" + String.valueOf(this.embeddedDocumentBytesConfig) + "}";
    }
