...
public final class MimeType implements Comparable, Serializable {
    private static final long serialVersionUID = 4357830439860729201L;
    private final MediaType type;
    private final int minLength = 0;
    private String acronym = "";
    private String uti = "";
    private List links = Collections.emptyList();
    private String description = "";
    private List magics = null;
    private List rootXML = null;
    ...
    public boolean matchesXML(String str, String str2) {
        List list = this.rootXML;
        if (list == null) {
            return false;
        }
        Iterator it = list.iterator();
        while (it.hasNext()) {
            if (((RootXML) it.next()).matches(str, str2)) {
                return true;
            }
        }
        return false;
