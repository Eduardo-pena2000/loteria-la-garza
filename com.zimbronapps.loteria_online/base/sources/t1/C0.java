...
public abstract class c0 {
    ...
    public static int a(Resources resources, int i, S1.i iVar, int i2) {
        int dimensionPixelSize;
        return i != -1 ? (i == 0 || (dimensionPixelSize = resources.getDimensionPixelSize(i)) < 0) ? i2 : dimensionPixelSize : ((Integer) iVar.get()).intValue();
    }
    ...
    public static float b(ViewConfiguration viewConfiguration, Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25 && (method = a) != null) {
            try {
                return ((Integer) method.invoke(viewConfiguration, (Object[]) null)).intValue();
            } catch (Exception unused) {
                Log.i("ViewConfigCompat", "Could not find method getScaledScrollFactor() on ViewConfiguration");
            }
        }
    ...
    public static int h(Context context, ViewConfiguration viewConfiguration, int i, int i2, int i3) {
        ...
        return a(resources, d, new a0(viewConfiguration), Integer.MIN_VALUE);
    }

    public static int i(Context context, ViewConfiguration viewConfiguration, int i, int i2, int i3) {
        if (Build.VERSION.SDK_INT >= 34) {
        ...
        Resources resources = context.getResources();
        int e = e(resources, i3, i2);
        Objects.requireNonNull(viewConfiguration);
        return a(resources, e, new b0(viewConfiguration), Integer.MAX_VALUE);
    }
