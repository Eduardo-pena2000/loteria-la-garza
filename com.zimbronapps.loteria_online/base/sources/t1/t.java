...
public abstract class t {
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? aVar.superDispatchKeyEvent(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && Z.f(view, keyEvent)) || aVar.superDispatchKeyEvent(keyEvent);
    }
