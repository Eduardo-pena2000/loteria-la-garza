...
public final class b implements o3.p {
    public static final o3.u d = new a();
    public final c a = new c();
    public final P2.z b = new P2.z(2786);
    public boolean c;
    ...
    public int e(o3.q qVar, o3.I i) {
        int read = qVar.read(this.b.e(), 0, 2786);
        if (read == -1) {
            return -1;
        }
        this.b.T(0);
