...
public abstract class a {
    ...
    public static class a {
        ...
        public final c.c a(Context context, Q1.e eVar) {
            if (eVar == null) {
                return null;
            }
        ...
        public c.c c(Context context) {
            return a(context, h(context));
        }

        public final Q1.e d(ProviderInfo providerInfo, PackageManager packageManager) {
            String str = providerInfo.authority;
            String str2 = providerInfo.packageName;
            return new Q1.e(str, str2, "emojicompat-emoji-font", b(this.a.b(packageManager, str2)));
        }
        ...
        public Q1.e h(Context context) {
            PackageManager packageManager = context.getPackageManager();
            g.i(packageManager, "Package manager required to locate emoji font provider");
