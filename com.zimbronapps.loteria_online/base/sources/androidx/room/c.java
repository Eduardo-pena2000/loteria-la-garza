...
public class c {
    ...
    public class a implements Runnable {
        ...
        public final Set a() {
            ...
            Cursor p = c.this.d.p(new m4.a("SELECT * FROM room_table_modification_log WHERE invalidated = 1;"));
            while (p.moveToNext()) {
                try {
        ...
        */
        public void run() {
            ...
            L28:
                androidx.room.c r2 = androidx.room.c.this     // Catch: java.lang.Throwable -> L54 android.database.sqlite.SQLiteException -> L56 java.lang.IllegalStateException -> L58
                g4.e r2 = r2.d     // Catch: java.lang.Throwable -> L54 android.database.sqlite.SQLiteException -> L56 java.lang.IllegalStateException -> L58
            ...
            L36:
                ...
                if (r3 == 0) goto L5f
                m4.c r2 = r2.i()     // Catch: java.lang.Throwable -> L54 android.database.sqlite.SQLiteException -> L56 java.lang.IllegalStateException -> L58
                m4.b r2 = r2.e1()     // Catch: java.lang.Throwable -> L54 android.database.sqlite.SQLiteException -> L56 java.lang.IllegalStateException -> L58
            ...
            L6f:
                ...
                s.b r2 = r2.j     // Catch: java.lang.Throwable -> L9a
    ...
    public void d(m4.b bVar) {
        synchronized (this) {
            try {
                ...
                m(bVar);
                this.g = bVar.J0("UPDATE room_table_modification_log SET invalidated = 0 WHERE invalidated = 1 ");
                this.f = true;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final void j(m4.b bVar, int i) {
    ...
    public final void k(m4.b bVar, int i) {
        String str = this.b[i];
        StringBuilder sb = new StringBuilder();
        for (String str2 : m) {
            sb.setLength(0);
