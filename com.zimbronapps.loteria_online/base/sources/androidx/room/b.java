...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 1) {
                ...
                int u0 = u0(a.a.q1(parcel.readStrongBinder()), parcel.readString());
            ...
            if (i == 2) {
                parcel.enforceInterface("androidx.room.IMultiInstanceInvalidationService");
                m1(a.a.q1(parcel.readStrongBinder()), parcel.readInt());
                parcel2.writeNoException();
                return true;
            }
            if (i == 3) {
    ...
    void b0(int i, String[] strArr);

    void m1(androidx.room.a aVar, int i);

    int u0(androidx.room.a aVar, String str);
}
