...
public interface n0 {
    ...
    void J(int i, List list, a0 a0Var);

    void K(int i, f fVar);

    void L(int i, Object obj, a0 a0Var);

    void M(int i, D.a aVar, Map map);

    void N(int i, Object obj, a0 a0Var);

    void O(int i, List list, a0 a0Var);
