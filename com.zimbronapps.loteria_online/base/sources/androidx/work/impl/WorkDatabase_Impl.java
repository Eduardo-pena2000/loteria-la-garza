...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public static /* synthetic */ m4.b K(WorkDatabase_Impl workDatabase_Impl, m4.b bVar) {
        workDatabase_Impl.a = bVar;
        return bVar;
    }

    public static /* synthetic */ void L(WorkDatabase_Impl workDatabase_Impl, m4.b bVar) {
    ...
    public class a extends g.a {
        ...
        public g.b g(m4.b bVar) {
            ...
            i4.f fVar = new i4.f("Dependency", hashMap, hashSet, hashSet2);
            i4.f a = i4.f.a(bVar, "Dependency");
            if (!fVar.equals(a)) {
            ...
            i4.f fVar2 = new i4.f("WorkSpec", hashMap2, hashSet3, hashSet4);
            i4.f a2 = i4.f.a(bVar, "WorkSpec");
            if (!fVar2.equals(a2)) {
            ...
            i4.f fVar3 = new i4.f("WorkTag", hashMap3, hashSet5, hashSet6);
            i4.f a3 = i4.f.a(bVar, "WorkTag");
            if (!fVar3.equals(a3)) {
            ...
            i4.f fVar4 = new i4.f("SystemIdInfo", hashMap4, hashSet7, new HashSet(0));
            i4.f a4 = i4.f.a(bVar, "SystemIdInfo");
            if (!fVar4.equals(a4)) {
            ...
            i4.f fVar5 = new i4.f("WorkName", hashMap5, hashSet8, hashSet9);
            i4.f a5 = i4.f.a(bVar, "WorkName");
            if (!fVar5.equals(a5)) {
            ...
            i4.f fVar6 = new i4.f("WorkProgress", hashMap6, hashSet10, new HashSet(0));
            i4.f a6 = i4.f.a(bVar, "WorkProgress");
            if (!fVar6.equals(a6)) {
            ...
            i4.f fVar7 = new i4.f("Preference", hashMap7, new HashSet(0), new HashSet(0));
            i4.f a7 = i4.f.a(bVar, "Preference");
            if (fVar7.equals(a7)) {
