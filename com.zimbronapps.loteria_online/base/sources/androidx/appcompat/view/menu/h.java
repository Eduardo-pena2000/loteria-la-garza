...
public class h {
    ...
    public final p.d a() {
        ...
        p.d bVar = Math.min(point.x, point.y) >= this.a.getResources().getDimensionPixelSize(i.d.a) ? new androidx.appcompat.view.menu.b(this.a, this.f, this.d, this.e, this.c) : new k(this.a, this.b, this.f, this.d, this.e, this.c);
        bVar.j(this.b);
        bVar.t(this.l);
        bVar.o(this.f);
        bVar.d(this.i);
