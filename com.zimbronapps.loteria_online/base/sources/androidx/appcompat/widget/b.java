...
public abstract class b extends ViewGroup {
    ...
    private void j(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (q.getVisibility() != 8) {
                a layoutParams = q.getLayoutParams();
                if (((LinearLayout.LayoutParams) layoutParams).width == -1) {
                    int i4 = ((LinearLayout.LayoutParams) layoutParams).height;
                    ((LinearLayout.LayoutParams) layoutParams).height = q.getMeasuredHeight();
    ...
    public void e(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (q != null && q.getVisibility() != 8 && r(i2)) {
                a layoutParams = q.getLayoutParams();
                h(canvas, b ? q.getRight() + ((LinearLayout.LayoutParams) layoutParams).rightMargin : (q.getLeft() - ((LinearLayout.LayoutParams) layoutParams).leftMargin) - this.l);
            }
        }
        if (r(virtualChildCount)) {
            View q2 = q(virtualChildCount - 1);
            if (q2 != null) {
                a layoutParams2 = q2.getLayoutParams();
                if (b) {
                    left = q2.getLeft() - ((LinearLayout.LayoutParams) layoutParams2).leftMargin;
                    i = this.l;
                    right = left - i;
                } else {
                    right = q2.getRight() + ((LinearLayout.LayoutParams) layoutParams2).rightMargin;
                }
            } else if (b) {
    ...
    public void f(Canvas canvas) {
        ...
        for (int i = 0; i < virtualChildCount; i++) {
            ...
            if (q != null && q.getVisibility() != 8 && r(i)) {
                g(canvas, (q.getTop() - ((LinearLayout.LayoutParams) q.getLayoutParams()).topMargin) - this.m);
            }
        }
        if (r(virtualChildCount)) {
            View q2 = q(virtualChildCount - 1);
            g(canvas, q2 == null ? (getHeight() - getPaddingBottom()) - this.m : q2.getBottom() + ((LinearLayout.LayoutParams) q2.getLayoutParams()).bottomMargin);
        }
    }
    ...
    public int getBaseline() {
        int i;
        if (this.b < 0) {
            return super/*android.view.View*/.getBaseline();
        }
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (q.getVisibility() != 8) {
                ...
                if (((LinearLayout.LayoutParams) layoutParams).height == -1) {
                    ...
                    ((LinearLayout.LayoutParams) layoutParams).width = q.getMeasuredWidth();
    ...
    */
    ...
    public b(Context context, AttributeSet attributeSet, int i) {
        ...
        this.c = 0;
        this.e = 8388659;
        c0 u = c0.u(context, attributeSet, j.a1, i, 0);
        Z.S(this, context, j.a1, attributeSet, u.q(), i, 0);
        int j = u.j(j.c1, -1);
        if (j >= 0) {
            setOrientation(j);
        }
        ...
        boolean a2 = u.a(j.d1, true);
        if (!a2) {
            setBaselineAligned(a2);
        }
        this.g = u.h(j.f1, -1.0f);
        this.b = u.j(j.e1, -1);
        this.h = u.a(j.i1, false);
        setDividerDrawable(u.f(j.g1));
        this.n = u.j(j.j1, 0);
        this.o = u.e(j.h1, 0);
        u.v();
    }
