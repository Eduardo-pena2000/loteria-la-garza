...
public class ActionBarContextView extends q.a {
    ...
    public /* bridge */ /* synthetic */ i0 f(int i, long j) {
        return super.f(i, j);
    }
    ...
    public final void i() {
        if (this.n == null) {
            ...
            this.n = childAt;
            this.o = childAt.findViewById(f.e);
            this.p = this.n.findViewById(f.d);
            if (this.q != 0) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ViewGroup.MarginLayoutParams layoutParams = this.k.getLayoutParams();
            int i5 = b ? layoutParams.rightMargin : layoutParams.leftMargin;
            int i6 = b ? layoutParams.leftMargin : layoutParams.rightMargin;
            int d = q.a.d(paddingRight, i5, b);
            paddingRight = q.a.d(d + e(this.k, d, paddingTop, paddingTop2, b), i6, b);
        }
        int i7 = paddingRight;
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        c0 u = c0.u(context, attributeSet, j.y, i, 0);
        Z.X(this, u.f(j.z));
        this.q = u.m(j.D, 0);
        this.r = u.m(j.C, 0);
        this.e = u.l(j.B, 0);
