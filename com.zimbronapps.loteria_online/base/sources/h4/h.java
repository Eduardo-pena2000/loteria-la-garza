...
public abstract class h {
    public static final String a = m.f("WrkDbPathHelper");
        ...
        if (b(context).exists()) {
            ...
            for (File file : f.keySet()) {
                ...
                if (file.exists() && file2 != null) {
                    if (file2.exists()) {
                        m.c().h(a, String.format("Over-writing contents of %s", new Object[]{file2}), new Throwable[0]);
                    }
                    m.c().a(a, file.renameTo(file2) ? String.format("Migrated %s to %s", new Object[]{file, file2}) : String.format("Renaming %s to %s failed", new Object[]{file, file2}), new Throwable[0]);
                }
            }
        }
    }
