...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityDestroyed$1 extends l implements p {
    final /* synthetic */ v $$this$channelFlow;
    final /* synthetic */ Activity $activity;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityDestroyed$1(v vVar, Activity activity, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o, e eVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityDestroyed$1) create(o, eVar)).invokeSuspend(I.a);
    }
