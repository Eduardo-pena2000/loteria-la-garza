...
public class GMAScarAdapterBridge {
    ...
    private void loadInterstitialAd(v9.c cVar) {
        this._scarAdapter.g(ClientProperties.getApplicationContext(), cVar, new ScarInterstitialAdHandler(cVar, getScarEventSubject(cVar.e()), this._gmaEventSender));
    }

    private void loadRewardedAd(v9.c cVar) {
    ...
    public void getSCARBiddingSignals(List list, BiddingSignalsHandler biddingSignalsHandler) {
    ...
    public void load(boolean z, String str, String str2, String str3, String str4, int i) {
        v9.c cVar = new v9.c(str, str2, str4, str3, Integer.valueOf(i));
        f scarAdapterObject = getScarAdapterObject();
        this._scarAdapter = scarAdapterObject;
        if (scarAdapterObject == null) {
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, v9.c cVar, UnityBannerSize unityBannerSize) {
        this._scarAdapter = getScarAdapterObject();
    ...
    public void getSCARBiddingSignals(boolean z, BiddingSignalsHandler biddingSignalsHandler) {
        ...
        if (mobileAdsBridgeBase != null && mobileAdsBridgeBase.hasSCARBiddingSupport()) {
            ...
            this._scarAdapter = scarAdapterObject;
            if (scarAdapterObject != null) {
                scarAdapterObject.b(ClientProperties.getApplicationContext(), z, biddingSignalsHandler);
                return;
            } else {
                biddingSignalsHandler.onSignalsCollectionFailed("Could not create SCAR adapter object.");
                return;
