...
public class GMA {
    ...
    public void getSCARBiddingSignals(List list, IBiddingSignalsListener iBiddingSignalsListener) {
        this._gmaScarAdapterBridge.getSCARBiddingSignals(list, new BiddingSignalsHandler(list.contains(d.BANNER), iBiddingSignalsListener));
    }
}
