...
public class ScarRewardedAdHandler extends ScarAdHandlerBase implements i {
    ...
    public ScarRewardedAdHandler(c cVar, EventSubject eventSubject, GMAEventSender gMAEventSender) {
    ...
    public void onAdFailedToShow(int i, String str) {
        this._gmaEventSender.send(com.unity3d.scar.adapter.common.c.REWARDED_SHOW_ERROR, this._scarAdMetadata.c(), this._scarAdMetadata.d(), str, Integer.valueOf(i));
    }
