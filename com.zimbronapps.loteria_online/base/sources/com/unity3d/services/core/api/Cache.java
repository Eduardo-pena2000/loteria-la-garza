...
public class Cache {
    ...
    public static void getMetaData(String str, JSONArray jSONArray, WebViewCallback webViewCallback) {
        try {
            ...
            webViewCallback.error(CacheError.INVALID_ARGUMENT, e.getMessage());
    ...
    @TargetApi(10)
    private static SparseArray getMetaData(String str, JSONArray jSONArray) throws JSONException, IOException, RuntimeException {
