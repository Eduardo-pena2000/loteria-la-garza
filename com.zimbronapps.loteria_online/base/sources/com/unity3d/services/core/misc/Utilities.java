...
public class Utilities {
    ...
    public static Map combineJsonIntoMap(Map map, JSONObject jSONObject, String str) {
        HashMap hashMap = new HashMap(map);
        Iterator keys = jSONObject.keys();
        while (keys.hasNext()) {
            String str2 = (String) keys.next();
            hashMap.put(str + str2, jSONObject.opt(str2));
        }
        return hashMap;
    }
    ...
    public static Object getService(String str, Class cls) {
        return ServiceProvider.INSTANCE.getRegistry().getService(str, Pa.a.c(cls));
    }
    ...
    */
    ...
    public static Map combineJsonIntoMap(Map map, JSONObject jSONObject) {
