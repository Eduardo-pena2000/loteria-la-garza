...
public class SdkProperties {
    ...
    public static /* synthetic */ void a(IUnityAdsInitializationListener iUnityAdsInitializationListener, UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        lambda$notifyInitializationFailed$0(iUnityAdsInitializationListener, unityAdsInitializationError, str);
    }
    ...
    public static String getDefaultConfigUrl(String str) {
        return "https://" + getConfigVersion(ClientProperties.getApplicationContext()) + '.' + (isChinaLocale(Device.getNetworkCountryISO()) ? new String(Base64.decode("dW5pdHlhZHMudW5pdHljaGluYS5jbg==", 0)) : "unityads.unity3d.com") + "/webview/" + getWebViewBranch() + "/" + str + "/config.json";
    }
    ...
    private static /* synthetic */ void lambda$notifyInitializationFailed$0(IUnityAdsInitializationListener iUnityAdsInitializationListener, UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    Utilities.wrapCustomerListener(new b(iUnityAdsInitializationListener));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static void notifyInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                Iterator it = linkedHashSet2.iterator();
                while (it.hasNext()) {
                    Utilities.wrapCustomerListener(new a((IUnityAdsInitializationListener) it.next(), unityAdsInitializationError, str));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static File getWebViewCacheDirectory(Context context) {
        if (_webviewCacheDirectory == null) {
            setWebViewCacheDirectory(new CacheDirectory("UnityAdsWebViewCache", false));
        }
