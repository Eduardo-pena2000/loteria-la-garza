...
public class Device {
    private static ConcurrentHashMap _reportedWarning = new ConcurrentHashMap();
    ...
    public static String getCertificateFingerprint() {
        try {
            ...
            return Utilities.toHexString(MessageDigest.getInstance("SHA-1").digest(CertificateFactory.getInstance("X.509").generateCertificate(new ByteArrayInputStream(signatureArr[0].toByteArray())).getEncoded()));
        } catch (Exception e) {
    ...
    */
    private static long getMemoryInfo(com.unity3d.services.core.device.Device.MemoryInfoType r6) {
        /*
            ...
            int[] r1 = com.unity3d.services.core.device.Device.1.$SwitchMap$com$unity3d$services$core$device$Device$MemoryInfoType
            int r2 = r6.ordinal()
            r1 = r1[r2]
            r2 = 1
            if (r1 == r2) goto L11
    ...
    */
    ...
    public static List selectAllDecodeCodecs(String str) {
        ArrayList arrayList = new ArrayList();
