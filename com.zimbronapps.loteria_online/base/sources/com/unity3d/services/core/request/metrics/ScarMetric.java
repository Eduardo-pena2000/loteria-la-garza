...
public class ScarMetric {
    ...
    public static Metric hbSignalsFetchFailure(boolean z, String str) {
        ...
        return new Metric(String.format("native_hb_signals_%s_fetch_failure", new Object[]{z ? "async" : "sync"}), Long.valueOf(getTotalFetchTime()), hashMap);
    }

    public static Metric hbSignalsFetchStart(boolean z) {
        _fetchStartTime = System.nanoTime();
        return new Metric(String.format("native_hb_signals_%s_fetch_start", new Object[]{z ? "async" : "sync"}), null);
    }

    public static Metric hbSignalsFetchSuccess(boolean z) {
        return new Metric(String.format("native_hb_signals_%s_fetch_success", new Object[]{z ? "async" : "sync"}), Long.valueOf(getTotalFetchTime()));
    }

    public static Metric hbSignalsUploadFailure(boolean z, String str) {
        HashMap hashMap = new HashMap();
        hashMap.put("reason", str);
        return new Metric(String.format("native_hb_signals_%s_upload_failure", new Object[]{z ? "async" : "sync"}), Long.valueOf(getTotalUploadTime()), hashMap);
    }

    public static Metric hbSignalsUploadStart(boolean z) {
        _uploadStartTime = System.nanoTime();
        return new Metric(String.format("native_hb_signals_%s_upload_start", new Object[]{z ? "async" : "sync"}), null);
    }

    public static Metric hbSignalsUploadSuccess(boolean z) {
        return new Metric(String.format("native_hb_signals_%s_upload_success", new Object[]{z ? "async" : "sync"}), Long.valueOf(getTotalUploadTime()));
    }
}
