...
public class AdOperationMetric {
    ...
    public class 1 extends HashMap {
        ...
        public 1(boolean z, String str, String str2, Boolean bool) {
            ...
            put("type", str2);
            if (bool != null) {
                put("is_header_bidding", String.valueOf(bool));
            }
        }
    }
    ...
    private static HashMap getTags(AdOperationError adOperationError, boolean z, boolean z2, Boolean bool) {
        return new 1(z, adOperationError == null ? "unknown" : adOperationError.toString(), z2 ? "banner" : "video", bool);
    }

    private static AdOperationError mapUnityAdsLoadError(UnityAds.UnityAdsLoadError unityAdsLoadError) {
        int i = 2.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
        if (i == 1) {
    ...
    private static AdOperationError mapUnityAdsShowError(UnityAds.UnityAdsShowError unityAdsShowError) {
        switch (2.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsShowError[unityAdsShowError.ordinal()]) {
            case 1:
                return AdOperationError.init_failed;
            case 2:
    ...
    public static Metric newAdLoadFailure(AdOperationError adOperationError, Long l, boolean z, boolean z2) {
        return new Metric("native_load_time_failure", l, getTags(adOperationError, true, z, Boolean.valueOf(z2)));
    }
    ...
    public static Metric newAdLoadSuccess(Long l, boolean z, boolean z2) {
        return new Metric("native_load_time_success", l, getTags(null, false, z, Boolean.valueOf(z2)));
    }

    public static Metric newAdShowFailure(AdOperationError adOperationError, Long l) {
        return new Metric("native_show_time_failure", l, getTags(adOperationError, true, false, null));
    }
    ...
    public static Metric newAdShowSuccess(Long l) {
        return new Metric("native_show_time_success", l, getTags(null, false, false, null));
    }
