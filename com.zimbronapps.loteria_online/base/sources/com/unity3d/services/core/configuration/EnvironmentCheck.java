...
public class EnvironmentCheck {
    ...
    public static boolean testProGuard() {
        try {
            Method method = WebViewBridgeInterface.class.getMethod("handleInvocation", new Class[]{String.class});
            Method method2 = WebViewBridgeInterface.class.getMethod("handleCallback", new Class[]{String.class, String.class, String.class});
            ...
            DeviceLog.exception("Unknown exception during Unity Ads ProGuard check: " + e2.getMessage(), e2);
            return true;
