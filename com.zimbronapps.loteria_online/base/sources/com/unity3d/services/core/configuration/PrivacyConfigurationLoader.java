...
public class PrivacyConfigurationLoader implements IConfigurationLoader {
    ...
    public class 1 implements IPrivacyConfigurationListener {
        final /* synthetic */ AtomicBoolean val$gameDisabled;

        public 1(AtomicBoolean atomicBoolean) {
            this.val$gameDisabled = atomicBoolean;
        }
        ...
        public void onError(PrivacyCallError privacyCallError, String str) {
            ...
            PrivacyConfigurationLoader.access$000(PrivacyConfigurationLoader.this).setPrivacyConfig(new PrivacyConfig());
            if (privacyCallError == PrivacyCallError.LOCKED_423) {
                this.val$gameDisabled.set(true);
            }
        }

        public void onSuccess(PrivacyConfig privacyConfig) {
            PrivacyConfigurationLoader.access$000(PrivacyConfigurationLoader.this).setPrivacyConfig(privacyConfig);
        }
    }
    ...
    public static /* synthetic */ PrivacyConfigStorage access$000(PrivacyConfigurationLoader privacyConfigurationLoader) {
        return privacyConfigurationLoader._privacyConfigStorage;
    }
