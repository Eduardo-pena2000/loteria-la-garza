...
public abstract class ByteString implements Iterable, Serializable {
    ...
    public class b implements Comparator {
        ...
        public int compare(ByteString byteString, ByteString byteString2) {
            ...
            while (it.hasNext() && it2.hasNext()) {
                int compareTo = Integer.valueOf(ByteString.access$200(it.nextByte())).compareTo(Integer.valueOf(ByteString.access$200(it2.nextByte())));
                if (compareTo != 0) {
                    return compareTo;
                }
            }
    ...
    public static final class e extends i {
        ...
        public void copyToInternal(byte[] bArr, int i, int i2, int i3) {
            System.arraycopy(this.a, b() + i, bArr, i2, i3);
        }
    ...
    public static class i extends h {
        ...
        public final ByteBuffer asReadOnlyByteBuffer() {
            return ByteBuffer.wrap(this.a, b(), size()).asReadOnlyBuffer();
        }
        ...
        public final boolean isValidUtf8() {
            int b = b();
            return W.u(this.a, b, size() + b);
        }

        public final CodedInputStream newCodedInput() {
            return CodedInputStream.newInstance(this.a, b(), size(), true);
        }

        public final InputStream newInput() {
            return new ByteArrayInputStream(this.a, b(), size());
        }

        public final int partialHash(int i, int i2, int i3) {
            return Internal.partialHash(i, this.a, b() + i2, i3);
        }

        public final int partialIsValidUtf8(int i, int i2, int i3) {
            int b = b() + i2;
            return W.w(i, this.a, b, i3 + b);
        }
        ...
        public final ByteString substring(int i, int i2) {
            ...
            return checkRange == 0 ? ByteString.EMPTY : new e(this.a, b() + i, checkRange);
        }
        ...
        public final void writeToInternal(OutputStream outputStream, int i, int i2) {
            outputStream.write(this.a, b() + i, i2);
        }

        public final void writeTo(ByteOutput byteOutput) {
            byteOutput.writeLazy(this.a, b(), size());
        }
    }
    ...
    private static ByteString balancedConcat(Iterator it, int i2) {
        if (i2 < 1) {
    ...
    public static final class Output extends OutputStream {
        ...
        private void flushLastBuffer() {
            ...
            if (i >= bArr.length) {
                ...
                this.flushedBuffers.add(new i(Arrays.copyOf(bArr, i)));
            }
