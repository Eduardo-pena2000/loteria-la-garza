...
public abstract class zznd extends zzko {
    ...
    private static zznd zzi(zznd zzndVar, byte[] bArr, int i, int i2, zzmo zzmoVar) throws zznn {
        if (i2 == 0) {
            return zzndVar;
        }
        ...
        try {
            ...
            if (e2.getCause() instanceof zznn) {
                throw e2.getCause();
            }
            throw new zznn(e2);
        } catch (zzpk e3) {
