...
public final class zzeu implements zzet {
    ...
    private static final void zzb(byte[] bArr) {
        for (zzrc zzrcVar : zzrf.zzk(bArr).zzl()) {
            ...
            List q = v.q(new String[]{"INIT_TOTAL", "EXECUTE_TOTAL"});
            switch (zzrcVar.zzY()) {
                case 2:
                    str = "UNKNOWN";
                    break;
    ...
    public final boolean zza(byte[] bArr) {
        ...
        try {
            ...
            if (URLUtil.isHttpUrl(this.zza)) {
                ...
                t.e(openConnection2, "null cannot be cast to non-null type javax.net.ssl.HttpsURLConnection");
