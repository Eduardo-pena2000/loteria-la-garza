...
public final class zzew {
    ...
    public final zzoi zza(zzoi zzoiVar) {
        try {
            ...
            try {
                Object zzb = zzoiVar.zzD().zzb(c);
                t.e(zzb, "null cannot be cast to non-null type T of com.google.android.libraries.abuse.recaptcha.network.CaptchaFeConnection.getResponse");
                return (zzoi) zzb;
            } catch (Exception e) {
    ...
    public final void zze(byte[] bArr) {
        try {
            ...
            throw new zzbd(zzbb.zzc, zzba.zzal, e.getMessage());
        } catch (IOException e2) {
