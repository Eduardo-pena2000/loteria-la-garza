...
public final class zzht implements zzgx {
    ...
    public final Object zzb(Object obj, Object obj2) throws zzce {
        ...
        if (z5 && (obj2 instanceof byte[])) {
            ...
            i w = n.w(0, length3);
            ArrayList arrayList11 = new ArrayList(w.y(w, 10));
            M it = w.iterator();
            while (it.hasNext()) {
                int a = it.a();
                arrayList11.add(Byte.valueOf((byte) (bArr4[a] ^ bArr3[a])));
            }
        ...
        if (z6 && (obj2 instanceof short[])) {
            ...
            i w2 = n.w(0, length4);
            ArrayList arrayList12 = new ArrayList(w.y(w2, 10));
            M it2 = w2.iterator();
            while (it2.hasNext()) {
                int a2 = it2.a();
                arrayList12.add(Short.valueOf((short) (sArr4[a2] ^ sArr3[a2])));
            }
        ...
        if (z7 && (obj2 instanceof int[])) {
            ...
            i w3 = n.w(0, length5);
            ArrayList arrayList13 = new ArrayList(w.y(w3, 10));
            M it3 = w3.iterator();
            while (it3.hasNext()) {
                int a3 = it3.a();
                arrayList13.add(Integer.valueOf(iArr4[a3] ^ iArr3[a3]));
            }
        ...
        i w4 = n.w(0, length6);
        ArrayList arrayList14 = new ArrayList(w.y(w4, 10));
        M it4 = w4.iterator();
        while (it4.hasNext()) {
            int a4 = it4.a();
            arrayList14.add(Long.valueOf(jArr3[a4] ^ jArr4[a4]));
        }
