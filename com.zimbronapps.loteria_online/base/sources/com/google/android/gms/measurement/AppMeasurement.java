...
public class AppMeasurement {
    ...
    public AppMeasurement(q3 q3Var) {
        this.a = new a(q3Var);
    }
    ...
    public static AppMeasurement getInstance(Context context) {
        if (b == null) {
            synchronized (AppMeasurement.class) {
                if (b == null) {
                    c5 c5Var = (c5) FirebaseAnalytics.class.getDeclaredMethod("getScionFrontendApiImplementation", new Class[]{Context.class, Bundle.class}).invoke((Object) null, new Object[]{context, null});
                    if (c5Var != null) {
                        b = new AppMeasurement(c5Var);
                    } else {
                        b = new AppMeasurement(q3.O(context, new zzdd(0L, 0L, true, null, null), null));
                    }
                }
            }
        }
