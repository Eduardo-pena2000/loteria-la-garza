...
public final class zzies {
    ...
    static {
        zzies zziesVar = new zzies("DOUBLE", 0, zziet.zzd, 1);
        zza = zziesVar;
        zzies zziesVar2 = new zzies("FLOAT", 1, zziet.zzc, 5);
        zzb = zziesVar2;
        zziet zzietVar = zziet.zzb;
        zzies zziesVar3 = new zzies("INT64", 2, zzietVar, 0);
        zzc = zziesVar3;
        zzies zziesVar4 = new zzies("UINT64", 3, zzietVar, 0);
        zzd = zziesVar4;
        zziet zzietVar2 = zziet.zza;
        ...
        zzg = zziesVar7;
        zzies zziesVar8 = new zzies("BOOL", 7, zziet.zze, 0);
        zzh = zziesVar8;
        zzies zziesVar9 = new zzies("STRING", 8, zziet.zzf, 2);
        zzi = zziesVar9;
        zziet zzietVar3 = zziet.zzi;
        zzies zziesVar10 = new zzies("GROUP", 9, zzietVar3, 3);
        zzj = zziesVar10;
        zzies zziesVar11 = new zzies("MESSAGE", 10, zzietVar3, 2);
        zzk = zziesVar11;
        zzies zziesVar12 = new zzies("BYTES", 11, zziet.zzg, 2);
        zzl = zziesVar12;
        zzies zziesVar13 = new zzies("UINT32", 12, zzietVar2, 0);
        zzm = zziesVar13;
        zzies zziesVar14 = new zzies("ENUM", 13, zziet.zzh, 0);
        zzn = zziesVar14;
