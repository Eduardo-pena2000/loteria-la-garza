...
public final class zzafs {
    ...
    public static /* synthetic */ boolean zzc(int i) {
        return zzl(i);
    }

    public static /* synthetic */ int zzd(int i, int i2) {
        return zzm(i, i2);
    }

    public static /* synthetic */ String[] zze() {
        return zza;
    }

    public static /* synthetic */ int[] zzf() {
        return zzb;
    }

    public static /* synthetic */ int[] zzg() {
        return zzc;
    }

    public static /* synthetic */ int[] zzh() {
        return zzd;
    }

    public static /* synthetic */ int[] zzi() {
        return zze;
    }

    public static /* synthetic */ int[] zzj() {
        return zzf;
    }

    public static /* synthetic */ int[] zzk() {
        return zzg;
    }
    ...
    private static int zzm(int i, int i2) {
