...
public final class zzba {
        ...
        switch (c) {
            ...
            case 4:
                ...
                while (zzg3.hasNext()) {
                    ...
                    double d4 = intValue;
                    if (d4 >= d && zzh.zzf(zzaeVar.zzl(intValue), zzaoVar2)) {
            ...
            case 15:
                ...
                while (zzg4.hasNext()) {
                    ...
                    if (zzaeVar.zzo(intValue2) && zzaiVar2.zza(zzgVar, Arrays.asList(new zzao[]{zzaeVar.zzl(intValue2), new zzah(Double.valueOf(intValue2)), zzaeVar})).zze().booleanValue()) {
                        return zzao.zzk;
                    }
                }
                return zzao.zzl;
    ...
    private static zzao zzb(zzae zzaeVar, zzg zzgVar, List list, boolean z) {
        ...
        while ((i2 - i) * i3 >= 0) {
            if (zzaeVar.zzo(i)) {
                zzaoVar = zzaiVar.zza(zzgVar, Arrays.asList(new zzao[]{zzaoVar, zzaeVar.zzl(i), new zzah(Double.valueOf(i)), zzaeVar}));
                if (zzaoVar instanceof zzag) {
    ...
    private static zzae zzc(zzae zzaeVar, zzg zzgVar, zzai zzaiVar, Boolean bool, Boolean bool2) {
        ...
        while (zzg.hasNext()) {
            ...
            if (zzaeVar.zzo(intValue)) {
                zzao zza = zzaiVar.zza(zzgVar, Arrays.asList(new zzao[]{zzaeVar.zzl(intValue), new zzah(Double.valueOf(intValue)), zzaeVar}));
