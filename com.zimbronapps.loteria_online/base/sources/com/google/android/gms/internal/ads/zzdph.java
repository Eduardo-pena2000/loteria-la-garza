...
public final class zzdph implements zzikg {
    ...
    public final zzdpg zzb() {
        return new zzdpg(((zzcmd) this.zza).zza(), ((zzdaw) this.zzb).zza(), (zzdom) this.zzc.zzb(), ((zzdoz) this.zzd).zza(), (zzdpu) this.zze.zzb(), (zzdqc) this.zzf.zzb(), (Executor) this.zzg.zzb(), zzfmk.zzc(), (zzdoe) this.zzh.zzb());
    }
}
