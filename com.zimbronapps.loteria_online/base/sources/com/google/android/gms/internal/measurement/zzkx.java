...
final class zzkx {
    ...
    public static int zzf(byte[] bArr, int i, zzkw zzkwVar) throws zzmr {
        ...
        if ((((length - zza2) - i3) | zza2 | i3) < 0) {
            throw new ArrayIndexOutOfBoundsException(String.format("buffer length=%d, index=%d, size=%d", new Object[]{Integer.valueOf(length), Integer.valueOf(zza2), Integer.valueOf(i3)}));
        }
        int i5 = zza2 + i3;
