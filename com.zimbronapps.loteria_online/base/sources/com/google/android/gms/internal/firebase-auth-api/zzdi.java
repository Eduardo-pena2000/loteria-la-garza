...
public final class zzdi extends zzcy {
    ...
    public static final class zzb {
        ...
        public /* synthetic */ zzb(zzdk zzdkVar) {
            this();
        }
                        ...
                        if (num != null) {
                            if (this.zze != null) {
                                if (this.zzf != null) {
                                    ...
                                    return new zzdi(this.zza.intValue(), this.zzb.intValue(), this.zzc.intValue(), this.zzd.intValue(), this.zzf, this.zze, null);
                                }
    ...
    public /* synthetic */ zzdi(int i, int i2, int i3, int i4, zzc zzcVar, zza zzaVar, zzdk zzdkVar) {
        this(i, i2, i3, i4, zzcVar, zzaVar);
    }
