...
final class zzdx {
    ...
    public static int zzd(zzgv zzgvVar, byte[] bArr, int i, int i2, zzdw zzdwVar) throws IOException {
        Object zze = zzgvVar.zze();
    ...
    public static int zzg(byte[] bArr, int i, zzdw zzdwVar) throws zzfq {
        ...
        if ((((length - zzi) - i3) | zzi | i3) < 0) {
            throw new ArrayIndexOutOfBoundsException(String.format("buffer length=%d, index=%d, size=%d", new Object[]{Integer.valueOf(length), Integer.valueOf(zzi), Integer.valueOf(i3)}));
        }
        int i5 = zzi + i3;
