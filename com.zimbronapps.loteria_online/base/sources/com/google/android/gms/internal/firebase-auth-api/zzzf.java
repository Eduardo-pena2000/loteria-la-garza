...
public final class zzzf {
    ...
    public static KeyPair zza(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) zzzj.zzd.zza("EC");
        keyPairGenerator.initialize(eCParameterSpec);
        return keyPairGenerator.generateKeyPair();
    }

    public static ECPrivateKey zza(zzzi zzziVar, byte[] bArr) throws GeneralSecurityException {
        return ((KeyFactory) zzzj.zze.zza("EC")).generatePrivate(new ECPrivateKeySpec(zzne.zza(bArr), zza(zzziVar)));
    }

    public static ECPublicKey zza(ECParameterSpec eCParameterSpec, zzzh zzzhVar, byte[] bArr) throws GeneralSecurityException {
        return ((KeyFactory) zzzj.zze.zza("EC")).generatePublic(new ECPublicKeySpec(zza(eCParameterSpec.getCurve(), zzzhVar, bArr), eCParameterSpec));
    }
    ...
    private static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        PublicKey generatePublic = ((KeyFactory) zzzj.zze.zza("EC")).generatePublic(new ECPublicKeySpec(eCPoint, eCPrivateKey.getParams()));
        KeyAgreement keyAgreement = (KeyAgreement) zzzj.zzc.zza("ECDH");
