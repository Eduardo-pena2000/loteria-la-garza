...
public interface zzcr extends IInterface {
    ...
    void initialize(N6.a aVar, zzdd zzddVar, long j) throws RemoteException;
    ...
    void logHealthData(int i, String str, N6.a aVar, N6.a aVar2, N6.a aVar3) throws RemoteException;

    void onActivityCreated(N6.a aVar, Bundle bundle, long j) throws RemoteException;

    void onActivityCreatedByScionActivityInfo(zzdf zzdfVar, Bundle bundle, long j) throws RemoteException;

    void onActivityDestroyed(N6.a aVar, long j) throws RemoteException;

    void onActivityDestroyedByScionActivityInfo(zzdf zzdfVar, long j) throws RemoteException;

    void onActivityPaused(N6.a aVar, long j) throws RemoteException;

    void onActivityPausedByScionActivityInfo(zzdf zzdfVar, long j) throws RemoteException;

    void onActivityResumed(N6.a aVar, long j) throws RemoteException;

    void onActivityResumedByScionActivityInfo(zzdf zzdfVar, long j) throws RemoteException;

    void onActivitySaveInstanceState(N6.a aVar, zzcu zzcuVar, long j) throws RemoteException;

    void onActivitySaveInstanceStateByScionActivityInfo(zzdf zzdfVar, zzcu zzcuVar, long j) throws RemoteException;

    void onActivityStarted(N6.a aVar, long j) throws RemoteException;

    void onActivityStartedByScionActivityInfo(zzdf zzdfVar, long j) throws RemoteException;

    void onActivityStopped(N6.a aVar, long j) throws RemoteException;
    ...
    void setCurrentScreen(N6.a aVar, String str, String str2, long j) throws RemoteException;
    ...
    void setUserProperty(String str, String str2, N6.a aVar, boolean z, long j) throws RemoteException;
