...
final class zzakx {
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < zzb2; i++) {
            Map.Entry zza = this.zza.zza(i);
            zzakxVar.zzb((zzakz) zza.getKey(), zza.getValue());
        }
    ...
    private final void zzb(Map.Entry entry) {
        ...
        if (zzakzVar.zze()) {
            ...
            this.zza.zza(zzakzVar, zza);
            return;
        }
        if (zzakzVar.zzc() != zzaoj.zzi) {
            if (z) {
                throw new IllegalStateException("Lazy fields must be message-valued");
            }
            this.zza.zza(zzakzVar, zza(value));
            return;
        }
        Object zza2 = zza(zzakzVar);
        if (zza2 != null) {
            if (z) {
                throw new NoSuchMethodError();
            }
            this.zza.zza(zzakzVar, zza2 instanceof zzamr ? zzakzVar.zza((zzamr) zza2, (zzamr) value) : zzakzVar.zza(((zzamm) zza2).zzr(), (zzamm) value).zze());
        } else {
            this.zza.zza(zzakzVar, zza(value));
            if (z) {
                this.zzd = true;
    ...
    */
    private static void zzc(com.google.android.gms.internal.firebase-auth-api.zzakz r3, java.lang.Object r4) {
        /*
            com.google.android.gms.internal.firebase-auth-api.zzaog r0 = r3.zzb()
            com.google.android.gms.internal.firebase-auth-api.zzalh.zza(r4)
            int[] r1 = com.google.android.gms.internal.firebase-auth-api.zzala.zza
        ...
        L18:
            ...
            goto L46
        L1a:
            boolean r0 = r4 instanceof com.google.android.gms.internal.firebase-auth-api.zzamm
            if (r0 != 0) goto L46
            boolean r0 = r4 instanceof com.google.android.gms.internal.firebase-auth-api.zzalq
            if (r0 == 0) goto L18
            goto L46
        L23:
            boolean r0 = r4 instanceof java.lang.Integer
            if (r0 != 0) goto L46
            boolean r0 = r4 instanceof com.google.android.gms.internal.firebase-auth-api.zzalk
            if (r0 == 0) goto L18
            goto L46
        L2c:
            boolean r0 = r4 instanceof com.google.android.gms.internal.firebase-auth-api.zzajv
            if (r0 != 0) goto L46
        ...
        L49:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase-auth-api.zzakx.zzc(com.google.android.gms.internal.firebase-auth-api.zzakz, java.lang.Object):void");
    }
    ...
    private final void zzb(zzakz zzakzVar, Object obj) {
        if (zzakzVar.zze()) {
    ...
    public static int zza(zzakz zzakzVar, Object obj) {
        ...
        if (zzakzVar.zze()) {
            ...
            return zzakn.zzh(zza) + i3 + zzakn.zzi(i3);
        }
    ...
    private static int zza(Map.Entry entry) {
        ...
        if (zzakzVar.zzc() == zzaoj.zzi && !zzakzVar.zze() && !zzakzVar.zzd()) {
            if (value instanceof zzalq) {
                return zzakn.zza(((zzakz) entry.getKey()).zza(), (zzalq) value);
            }
            return zzakn.zza(((zzakz) entry.getKey()).zza(), (zzamm) value);
        }
        return zza(zzakzVar, value);
    }
    ...
    private final Object zza(zzakz zzakzVar) {
        Object obj = this.zza.get(zzakzVar);
        if (obj instanceof zzalq) {
            throw new NoSuchMethodError();
        }
        return obj;
