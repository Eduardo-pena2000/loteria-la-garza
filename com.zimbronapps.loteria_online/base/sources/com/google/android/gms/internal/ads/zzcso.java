...
public final class zzcso implements zzbss {
    ...
    public final JSONObject zzb(zzcsr zzcsrVar) throws JSONException {
        ...
        if (zzbddVar == null) {
            ...
            JSONObject put = jSONObject3.put("afmaVersion", zzbdbVar.zzb()).put("activeViewJSON", zzbdbVar.zzc()).put("timestamp", zzcsrVar.zzd).put("adFormat", zzbdbVar.zza()).put("hashCode", zzbdbVar.zzd()).put("isMraid", false).put("isStopped", false).put("isPaused", zzcsrVar.zzb).put("isNative", zzbdbVar.zze()).put("isScreenOn", this.zzc.isInteractive()).put("appMuted", R5.t.m().d()).put("appVolume", R5.t.m().b());
            Context context = this.zza;
            put.put("deviceVolume", V5.b.e(context.getApplicationContext()));
            DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
            JSONObject put2 = jSONObject3.put("windowVisibility", zzbddVar.zzb).put("isAttachedToWindow", z);
            ...
            if (((Boolean) S5.D.c().zzd(zzbhe.zzbW)).booleanValue()) {
