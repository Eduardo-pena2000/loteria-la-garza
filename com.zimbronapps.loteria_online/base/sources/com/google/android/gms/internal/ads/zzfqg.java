...
public final class zzfqg {
    ...
    public zzfqg(zzenr zzenrVar, W5.a aVar, String str, String str2, Context context, zzfjd zzfjdVar, zzfje zzfjeVar, E6.f fVar, zzazh zzazhVar) {
        this.zza = zzenrVar;
        this.zzb = aVar.a;
        this.zzc = str;
        this.zzd = str2;
    ...
    public static /* synthetic */ String zze(zzfjd zzfjdVar) {
        return zzg(zzfjdVar.zza);
    }

    public static /* synthetic */ String zzf(zzfjd zzfjdVar) {
        return zzg(zzfjdVar.zzb);
    }

    private static String zzg(String str) {
        return TextUtils.isEmpty(str) ? "" : W5.m.j() ? "fakeForAdDebugLog" : str;
    }
