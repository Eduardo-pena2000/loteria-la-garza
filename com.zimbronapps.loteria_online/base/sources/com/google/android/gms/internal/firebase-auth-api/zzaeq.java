...
public final class zzaeq extends AsyncTask {
    ...
    public zzaeq(String str, String str2, Intent intent, g gVar, zzaes zzaesVar) {
        ...
        t.f(str2);
        t.l(intent);
        String f = t.f(intent.getStringExtra("com.google.firebase.auth.KEY_API_KEY"));
        Uri.Builder buildUpon = Uri.parse(zzaesVar.zza(f)).buildUpon();
        buildUpon.appendPath("getProjectConfig").appendQueryParameter("key", f).appendQueryParameter("androidPackageName", str).appendQueryParameter("sha1Cert", (String) t.l(str2));
    ...
    public final zzaep doInBackground(Void... voidArr) {
        try {
            ...
            zzaes zzaesVar = (zzaes) this.zzd.get();
            URLConnection zza2 = zzaesVar.zza(url);
            ...
            zza.c("Null pointer encountered: " + e2.getMessage(), new Object[0]);
            return null;
        } catch (IOException e3) {
            zza.c("IOException occurred: " + e3.getMessage(), new Object[0]);
            return null;
        }
    }
    ...
    private static String zza(HttpURLConnection httpURLConnection) throws zzacn {
        try {
            ...
            zza.h("Error parsing error message from response body in getErrorMessageFromBody. " + String.valueOf(e), new Object[0]);
            return null;
        }
    }
    ...
    public final void onPostExecute(zzaep zzaepVar) {
        ...
        if (zzaesVar == null) {
            ...
            zzaesVar.zza(this.zze.build(), this.zzb, FirebaseAuth.getInstance(this.zzg).u0());
        } else {
            zzaesVar.zza(this.zzb, q.a(str2));
        }
    }
