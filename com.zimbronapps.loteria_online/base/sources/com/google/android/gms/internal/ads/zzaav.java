...
public final class zzaav implements zzaas, zzhz {
    ...
    public /* synthetic */ zzaav(Context context, Map map, int i, zzdn zzdnVar, boolean z, byte[] bArr) {
        ...
        this.zzs = zzc2;
        this.zzq = zzl(zzc2);
        zza2.zzb(new zzaau(this), zzdh.zza());
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x003c A[Catch: all -> 0x000a, TryCatch #0 {all -> 0x000a, blocks: (B:3:0x0001, B:5:0x0005, B:11:0x000d, B:17:0x0019, B:19:0x001d, B:21:0x0023, B:23:0x002d, B:25:0x0037, B:26:0x0048, B:27:0x003c, B:28:0x004a, B:30:0x0058, B:32:0x0061), top: B:2:0x0001 }] */
