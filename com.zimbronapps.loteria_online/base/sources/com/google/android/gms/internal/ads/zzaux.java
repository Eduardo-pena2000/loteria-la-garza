...
public final class zzaux {
    ...
    public final zzavg zzc() throws zzauv {
        ...
        int i12 = i10 ^ i9;
        ArrayList arrayList = this.zza;
        zzavg zzavgVar = (zzavg) arrayList.get(i11 + i12);
        arrayList.set(this.zzb + i12, (Object) null);
        this.zzb += i12;
        return zzavgVar;
    }

    public final zzavg zzd(long j) throws zzauv {
        return (zzavg) this.zza.get(zza(j));
    }

    public final void zze(long j, zzavg zzavgVar) throws zzauv {
