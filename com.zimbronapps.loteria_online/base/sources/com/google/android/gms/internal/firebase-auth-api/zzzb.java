...
public final class zzzb implements zzbd {
    ...
    public static zzbd zza(zzke zzkeVar) throws GeneralSecurityException {
        ECPrivateKey zza = zzzf.zza((zzzi) zzze.zza.zza(((zzkb) ((zzlg) zzkeVar.zza())).zzd()), zzne.zza(zzkeVar.zzf().zza(zzbf.zza())));
        byte[] bArr = new byte[0];
        if (((zzkb) ((zzlg) zzkeVar.zza())).zzh() != null) {
            bArr = ((zzkb) ((zzlg) zzkeVar.zza())).zzh().zzb();
        }
        return new zzzb(zza, bArr, zzze.zza(((zzkb) ((zzlg) zzkeVar.zza())).zze()), (zzzh) zzze.zzb.zza(((zzkb) ((zzlg) zzkeVar.zza())).zzf()), zzln.zza((zzkb) ((zzlg) zzkeVar.zza())), zzkeVar.zzh().zzb());
    }
    ...
    */
    public final byte[] zza(byte[] r11, byte[] r12) throws java.security.GeneralSecurityException {
        /*
            r10 = this;
            byte[] r0 = r10.zzg
            boolean r0 = com.google.android.gms.internal.firebase-auth-api.zzqn.zza(r0, r11)
            if (r0 == 0) goto L5f
            byte[] r0 = r10.zzg
            int r0 = r0.length
            ...
            int r1 = com.google.android.gms.internal.firebase-auth-api.zzzf.zza(r1)
            int r2 = r2.ordinal()
            r3 = 2
            r4 = 1
            if (r2 == 0) goto L33
        ...
        L5f:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase-auth-api.zzzb.zza(byte[], byte[]):byte[]");
    }
}
