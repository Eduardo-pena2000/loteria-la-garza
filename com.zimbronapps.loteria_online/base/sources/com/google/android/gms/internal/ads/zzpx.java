...
public final class zzpx {
    ...
    public zzpx(Context context, zzpw zzpwVar, zzd zzdVar, AudioDeviceInfo audioDeviceInfo) {
        ...
        Handler handler = new Handler(zzfj.zze(), (Handler.Callback) null);
        this.zzc = handler;
        this.zzd = new zzpt(this, null);
    ...
    public final zzps zzd() {
        ...
        zzps zzb = zzps.zzb(context, context.registerReceiver(this.zze, new IntentFilter("android.media.action.HDMI_AUDIO_PLUG"), (String) null, handler), this.zzi, this.zzh);
        this.zzg = zzb;
        return zzb;
    }
