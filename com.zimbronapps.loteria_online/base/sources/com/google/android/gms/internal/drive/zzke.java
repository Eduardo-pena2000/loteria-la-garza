...
LI11I1ll1Ii11.IIiLliI1l1li1: Init of enum field 'zzoy' uses external variables
...
public final class zzke {
    private static final zzke zzoy;
    private static final zzke zzoz;
    private static final zzke zzpa;
    private static final zzke zzpb;
    private static final zzke zzpc;
    private static final zzke zzpd;
    private static final zzke zzpe;
    private static final zzke zzpf;
    private static final zzke zzpg;
    private static final zzke zzph;
    private static final zzke zzpi;
    private static final zzke zzpj;
    private static final zzke zzpk;
    private static final zzke zzpl;
    private static final zzke zzpm;
    private static final zzke zzpn;
    private static final zzke zzpo;
    private static final zzke zzpp;
    private static final zzke zzpq;
    private static final zzke zzpr;
    private static final zzke zzps;
    private static final zzke zzpt;
    private static final zzke zzpu;
    private static final zzke zzpv;
    private static final zzke zzpw;
    private static final zzke zzpx;
    private static final zzke zzpy;
    private static final zzke zzpz;
    private static final zzke zzqa;
    private static final zzke zzqb;
    private static final zzke zzqc;
    private static final zzke zzqd;
    private static final zzke zzqe;
    private static final zzke zzqf;
    private static final zzke zzqg;
    public static final zzke zzqh;
    private static final zzke zzqi;
    private static final zzke zzqj;
    private static final zzke zzqk;
    private static final zzke zzql;
    private static final zzke zzqm;
    private static final zzke zzqn;
    private static final zzke zzqo;
    private static final zzke zzqp;
    private static final zzke zzqq;
    private static final zzke zzqr;
    private static final zzke zzqs;
    private static final zzke zzqt;
    public static final zzke zzqu;
    private static final zzke zzqv;
    private static final zzke zzqw;
    private static final zzke[] zzrb;
    private static final Type[] zzrc;
    private static final /* synthetic */ zzke[] zzrd;
    ...
    static {
        ...
        zzqu = zzkeVar49;
        zzke zzkeVar50 = new zzke("GROUP_LIST", 49, 49, zzkgVar2, zzksVar7);
        zzqv = zzkeVar50;
        zzke zzkeVar51 = new zzke("MAP", 50, 50, zzkg.zzrj, zzks.zzsr);
        zzqw = zzkeVar51;
        zzrd = new zzke[]{zzkeVar, zzkeVar2, zzkeVar3, zzkeVar4, zzkeVar5, zzkeVar6, zzkeVar7, zzkeVar8, zzkeVar9, zzkeVar10, zzkeVar11, zzkeVar12, zzkeVar13, zzkeVar14, zzkeVar15, zzkeVar16, zzkeVar17, zzkeVar18, zzkeVar19, zzkeVar20, zzkeVar21, zzkeVar22, zzkeVar23, zzkeVar24, zzkeVar25, zzkeVar26, zzkeVar27, zzkeVar28, zzkeVar29, zzkeVar30, zzkeVar31, zzkeVar32, zzkeVar33, zzkeVar34, zzkeVar35, zzkeVar36, zzkeVar37, zzkeVar38, zzkeVar39, zzkeVar40, zzkeVar41, zzkeVar42, zzkeVar43, zzkeVar44, zzkeVar45, zzkeVar46, zzkeVar47, zzkeVar48, zzkeVar49, zzkeVar50, zzkeVar51};
        zzrc = new Type[0];
        zzke[] values = values();
        zzrb = new zzke[values.length];
        for (zzke zzkeVar52 : values) {
            zzrb[zzkeVar52.id] = zzkeVar52;
        }
    }

    private zzke(String str, int i, int i2, zzkg zzkgVar, zzks zzksVar) {
        int i3;
        this.id = i2;
        this.zzqy = zzkgVar;
        this.zzqx = zzksVar;
        int i4 = zzkf.zzre[zzkgVar.ordinal()];
        if (i4 == 1) {
        ...
        this.zzra = (zzkgVar != zzkg.zzrg || (i3 = zzkf.zzrf[zzksVar.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }

    public static zzke[] values() {
        return (zzke[]) zzrd.clone();
    }
