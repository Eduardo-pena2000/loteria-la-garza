...
public final class zziv {
    ...
    public static abstract class zza {
        ...
        static {
            zzix zzixVar = new zzix("ALGORITHM_NOT_FIPS", 0, null);
            zza = zzixVar;
            zziz zzizVar = new zziz("ALGORITHM_REQUIRES_BORINGCRYPTO", 1, null);
            zzb = zzizVar;
            zzc = new zza[]{zzixVar, zzizVar};
        }

        public /* synthetic */ zza(String str, int i, zziy zziyVar) {
            this(str, i);
        }
