...
public final class zzdx extends zzcy {
    ...
    public static final class zzb {
        ...
        public /* synthetic */ zzb(zzea zzeaVar) {
            this();
        }
        ...
        public final zzdx zza() throws GeneralSecurityException {
            ...
            if (num != null) {
                if (this.zzd != null) {
                    if (this.zzb != null) {
                        if (this.zzc != null) {
                            return new zzdx(num.intValue(), this.zzb.intValue(), this.zzc.intValue(), this.zzd, null);
                        }
    ...
    public /* synthetic */ zzdx(int i, int i2, int i3, zza zzaVar, zzea zzeaVar) {
        this(i, i2, i3, zzaVar);
    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{zzdx.class, Integer.valueOf(this.zza), Integer.valueOf(this.zzb), Integer.valueOf(this.zzc), this.zzd});
    }
