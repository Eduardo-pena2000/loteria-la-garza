...
public final class zzc {
    ...
    public static InAppMessageResult zzi(Bundle bundle, String str) {
        return bundle == null ? new InAppMessageResult(0, (String) null) : new InAppMessageResult(zzp(bundle, "BillingClient"), bundle.getString("IN_APP_MESSAGE_PURCHASE_TOKEN"));
    }
    ...
    public static List zzl(Bundle bundle) {
        ...
        if (stringArrayList == null || stringArrayList2 == null) {
            ...
            for (int i = 0; i < stringArrayList.size() && i < stringArrayList2.size(); i++) {
                Purchase zzq2 = zzq((String) stringArrayList.get(i), (String) stringArrayList2.get(i));
                if (zzq2 != null) {
                    arrayList.add(zzq2);
                }
            }
