...
public final class zzavg {
    ...
    public static zzavg zza(Object obj) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 1937477084);
        zzavgVar.zzb = obj;
        return zzavgVar;
    }
    ...
    public static zzavg zzb(long j) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 327254586);
        zzavgVar.zzc = j;
        return zzavgVar;
    }
    ...
    public static zzavg zzc(double d) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 1605908235);
        zzavgVar.zzd = d;
        return zzavgVar;
    }
    ...
    public static zzavg zzd(zzauk zzaukVar) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 1402586708);
    ...
    public static zzavg zze(List list) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 324763920);
        zzavgVar.zzf = list;
        return zzavgVar;
    }
    ...
    public static zzavg zzf(zzauy zzauyVar) {
        ...
        int i8 = iArr[7];
        zzavgVar.zzr();
        zzavgVar.zza = (i7 + ((((i2 & (~i)) | i3) + ((i & i4) | i5)) - i6)) ^ (i8 % 474613996);
    ...
    */
    public final java.lang.Object zzi(java.lang.Class r14) throws com.google.android.gms.internal.ads.zzavd {
        /*
    ...
    public final void zzk(OutputStream outputStream) throws zzavd, IOException {
        ...
        switch (i6) {
            ...
            case 4:
                List zzo = zzo();
                zzaug.zzb(zzo.size(), new zzavf(outputStream, i3 ^ i4), true);
                Iterator it = zzo.iterator();
                while (it.hasNext()) {
            ...
            case 6:
                int i7 = i ^ i2;
                double zzq = zzq();
                zzavf zzavfVar = new zzavf(outputStream, i7);
