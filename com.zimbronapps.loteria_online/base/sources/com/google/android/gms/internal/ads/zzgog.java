...
public final class zzgog {
    ...
    private static Intent zzc(Intent intent, int i, int i2) {
        ...
        if (zzd(0, 1)) {
            zzgrc.zzb(!zzd(i, 67108864), "Cannot set mutability flags if PendingIntent.FLAG_IMMUTABLE is set.");
        } else {
            zzgrc.zzb(zzd(i, 67108864), "Must set PendingIntent.FLAG_IMMUTABLE for SDK >= 23 if no parts of intent are mutable.");
        }
