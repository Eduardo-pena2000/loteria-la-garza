...
public final class zzaen {
    ...
    */
    public static B7.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase-auth-api.zzaen.zza(com.google.android.gms.common.api.Status):B7.m");
    }
    ...
    public static m zza(Status status, h hVar, String str, String str2) {
        int O1 = status.O1();
        if (O1 != 17012 && O1 != 17007 && O1 != 17025) {
            return zza(status);
        }
        return new x(zza(O1), zza(zzb(O1), status)).d(hVar).e(str);
    }

    public static u zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, A a) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaasVar);
        Pair pair = (Pair) zza.get(17078);
        return new u((String) pair.first, (String) pair.second, n.R1(zzaasVar, firebaseAuth, a));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.P1())) {
            return str;
        }
        return String.format(str + " [ %s ]", new Object[]{status.P1()});
    }
