...
public final class zzcx {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{this.zza, this.zzb, this.zzc, this.zzd, Float.valueOf(this.zze), Integer.valueOf(this.zzf), Integer.valueOf(this.zzg), Float.valueOf(this.zzh), Integer.valueOf(this.zzi), Float.valueOf(this.zzj), Float.valueOf(this.zzk), Boolean.FALSE, -16777216, Integer.valueOf(this.zzl), Float.valueOf(this.zzm), Integer.valueOf(this.zzn), Float.valueOf(this.zzo), Integer.valueOf(this.zzp)});
    }
    ...
    public final Bundle zzb() {
        ...
        Spanned spanned = this.zza;
        if (spanned != null) {
            bundle.putCharSequence(zzq, spanned);
            if (spanned instanceof Spanned) {
                ArrayList zza = zzda.zza(spanned);
                if (!zza.isEmpty()) {
