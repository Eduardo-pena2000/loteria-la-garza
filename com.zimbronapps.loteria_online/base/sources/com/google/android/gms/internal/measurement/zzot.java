...
public final class zzot {
    ...
    static {
        zzot zzotVar = new zzot("DOUBLE", 0, zzou.zzd, 1);
        zza = zzotVar;
        zzot zzotVar2 = new zzot("FLOAT", 1, zzou.zzc, 5);
        zzb = zzotVar2;
        zzou zzouVar = zzou.zzb;
        ...
        zzg = zzotVar7;
        zzot zzotVar8 = new zzot("BOOL", 7, zzou.zze, 0);
        zzh = zzotVar8;
        zzot zzotVar9 = new zzot("STRING", 8, zzou.zzf, 2);
        zzi = zzotVar9;
        zzou zzouVar3 = zzou.zzi;
        zzot zzotVar10 = new zzot("GROUP", 9, zzouVar3, 3);
        zzj = zzotVar10;
        zzot zzotVar11 = new zzot("MESSAGE", 10, zzouVar3, 2);
        zzk = zzotVar11;
        zzot zzotVar12 = new zzot("BYTES", 11, zzou.zzg, 2);
        zzl = zzotVar12;
        zzot zzotVar13 = new zzot("UINT32", 12, zzouVar2, 0);
        zzm = zzotVar13;
        zzot zzotVar14 = new zzot("ENUM", 13, zzou.zzh, 0);
        zzn = zzotVar14;
