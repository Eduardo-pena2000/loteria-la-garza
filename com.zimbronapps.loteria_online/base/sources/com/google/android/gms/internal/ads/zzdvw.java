        ...
        if (jSONArray != null && str != null) {
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                try {
                    ...
                    R5.t.l().zzg(e, "RtbAdapterMap.hasAtleastOneRegexMatch");
                }
                if ((((Boolean) S5.D.c().zzd(zzbhe.zzms)).booleanValue() ? Pattern.compile(optString, 2) : Pattern.compile(optString)).matcher(str).lookingAt()) {
                    return true;
                }
            }
        }
