...
public final class zzdm {
    ...
    public final void zza(zzgqt zzgqtVar, zzgqt zzgqtVar2) {
        zzgrc.zzi(Looper.myLooper() == this.zzb.zza());
        this.zzf++;
        zzc(new zzdk(this, zzgqtVar2));
        zzh(zzgqtVar.apply(this.zzd));
    }

    public final void zzb(Object obj) {
        this.zze = obj;
        zzg(new zzdi(this, obj));
    }
    ...
    public final /* synthetic */ void zzd(zzgqt zzgqtVar) {
        Object apply = zzgqtVar.apply(this.zze);
        this.zze = apply;
        zzg(new zzdj(this, apply));
    }
