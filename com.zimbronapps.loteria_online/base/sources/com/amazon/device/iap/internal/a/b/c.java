...
public final class c extends b {
    ...
    public boolean b(j jVar) throws Exception {
        ...
        JSONArray jSONArray = new JSONArray((String) b.get("receipts"));
        ...
        JSONArray jSONArray2 = new JSONArray((String) b.get("revocations"));
        ...
        boolean equalsIgnoreCase = "true".equalsIgnoreCase((String) b.get("hasMore"));
