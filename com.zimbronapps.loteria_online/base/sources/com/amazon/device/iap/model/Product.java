...
public final class Product implements Parcelable {
    ...
    public /* synthetic */ Product(Parcel parcel, 1 r2) {
        this(parcel);
    }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        if (this.promotions != null) {
            ...
            while (it.hasNext()) {
                jSONArray.put(((Promotion) it.next()).toJSON());
            }
    ...
    public Product(ProductBuilder productBuilder) {
        ...
        f.a(productBuilder.getProductType(), "productType");
        f.a((Object) productBuilder.getDescription(), "description");
        f.a((Object) productBuilder.getTitle(), "title");
        f.a((Object) productBuilder.getSmallIconUrl(), "smallIconUrl");
