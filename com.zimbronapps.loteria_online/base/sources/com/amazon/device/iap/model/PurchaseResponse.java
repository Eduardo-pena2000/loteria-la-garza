...
public final class PurchaseResponse {
    ...
    public PurchaseResponse(PurchaseResponseBuilder purchaseResponseBuilder) {
        ...
        if (purchaseResponseBuilder.getRequestStatus() == RequestStatus.SUCCESSFUL) {
            ...
            f.a(purchaseResponseBuilder.getUserData(), "userData");
        }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        jSONObject.put("userData", userData != null ? userData.toJSON() : "");
    ...
    public String toString() {
        ...
        return String.format("(%s, requestId: \"%s\", purchaseRequestStatus: \"%s\", userId: \"%s\", receipt: %s)", new Object[]{obj, requestId, requestStatus != null ? requestStatus.toString() : "null", this.userData, this.receipt});
    }
}
