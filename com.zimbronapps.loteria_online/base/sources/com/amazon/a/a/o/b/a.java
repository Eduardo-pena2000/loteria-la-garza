...
public class a {
    ...
    public a() throws GeneralSecurityException {
        ...
        for (X509TrustManager x509TrustManager : trustManagerFactory.getTrustManagers()) {
            if ((x509TrustManager instanceof X509TrustManager) && (acceptedIssuers = x509TrustManager.getAcceptedIssuers()) != null) {
                int i = 0;
                for (X509Certificate x509Certificate : acceptedIssuers) {
                    if (a(x509Certificate)) {
                        ...
                        this.e.add(new TrustAnchor(x509Certificate, (byte[]) null));
                        i++;
                    }
                }
                if (com.amazon.a.a.o.c.a) {
