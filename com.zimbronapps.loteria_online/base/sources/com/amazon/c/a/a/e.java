...
public class e {
    private static final String a = String.format("A valid instance of %s is required to have at least one non-blank ID, either developerId or certificateId, and at least one non-blank name, either developerName or commonName.", new Object[]{e.class.getSimpleName()});
    private static final String b = String.format("A valid instance of %s is required to have a certificate ID.", new Object[]{e.class.getSimpleName()});
    private String c;
    private String d;
    private String e;
    private String f;
