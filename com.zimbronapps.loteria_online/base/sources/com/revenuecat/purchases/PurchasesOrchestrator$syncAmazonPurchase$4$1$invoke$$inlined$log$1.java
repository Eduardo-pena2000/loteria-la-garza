...
public final class PurchasesOrchestrator$syncAmazonPurchase$4$1$invoke$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Purchase %s synced %s", Arrays.copyOf(new Object[]{this.$receiptID$inlined, this.$amazonUserID$inlined}, 2));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
