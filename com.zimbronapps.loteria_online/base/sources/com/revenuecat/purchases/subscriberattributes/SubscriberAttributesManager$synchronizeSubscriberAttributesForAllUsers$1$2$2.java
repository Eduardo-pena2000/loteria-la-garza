...
public final class SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$2 extends u implements q {
    ...
    public SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$2(SubscriberAttributesManager subscriberAttributesManager, String str, Map map, M m, Qa.a aVar, int i) {
        super(3);
    ...
    public final void invoke(PurchasesError purchasesError, boolean z, List list) {
        ...
        SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$2$invoke$$inlined$log$1 subscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$2$invoke$$inlined$log$1 = new SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$2$invoke$$inlined$log$1(logIntent, this.$syncingAppUserID, purchasesError);
