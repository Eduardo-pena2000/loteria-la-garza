...
public final class PurchasesFactory$createPurchases$lambda$8$$inlined$log$4 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Initial App User ID - %s", Arrays.copyOf(new Object[]{this.$this_with$inlined.getAppUserID()}, 1));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
