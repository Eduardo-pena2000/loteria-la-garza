...
public final class StoreProductMapperKt$mapAsync$1$map$1 extends l implements p {
    final /* synthetic */ List $this_mapAsync;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreProductMapperKt$mapAsync$1$map$1(List list, e eVar) {
        super(2, eVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        t.b(obj);
        return StoreProductMapperKt.access$map(this.$this_mapAsync);
    }
}
