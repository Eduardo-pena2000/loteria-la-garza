...
public final class CommonKt$purchaseProduct$onReceiveStoreProducts$1 extends u implements l {
    ...
    public static final class 7 extends u implements l {
        final /* synthetic */ OnResult $onResult;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public 7(OnResult onResult) {
            super(1);
    ...
    public static final class 8 extends u implements l {
        final /* synthetic */ List $addOnPackages;
        final /* synthetic */ OnResult $onResult;
        final /* synthetic */ Map $presentedOfferingContext;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public 8(Map map, OnResult onResult, List list, PurchaseParams.Builder builder) {
            super(1);
        ...
        public final void invoke(Offerings offerings) {
            ...
            try {
                ...
                this.$onResult.onError(PurchasesErrorKt.map$default(new PurchasesError(PurchasesErrorCode.PurchaseInvalidError, e.getLocalizedMessage()), null, 1, null));
            }
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CommonKt$purchaseProduct$onReceiveStoreProducts$1(String str, ProductType productType, String str2, Activity activity, Map map, String str3, GoogleReplacementMode googleReplacementMode, Boolean bool, List list, List list2, List list3, OnResult onResult) {
        super(1);
    ...
    public final void invoke(List list) {
        ...
        StoreProduct access$storeProductForProductId = CommonKt.access$storeProductForProductId(this.$productIdentifier, this.$productType, this.$googleBasePlanId, list);
        List list2 = null;
        if (access$storeProductForProductId == null) {
        ...
        PurchaseParams.Builder builder = new PurchaseParams.Builder(this.$activity, access$storeProductForProductId);
        Map map = this.$presentedOfferingContext;
        ...
        if (list3 == null || list3.isEmpty()) {
            ...
            ListenerConversionsCommonKt.getOfferingsWith(Purchases.Companion.getSharedInstance(), new 7(this.$onResult), new 8(this.$presentedOfferingContext, this.$onResult, this.$addOnPackages, builder));
        }
    }
}
