...
public final class BillingWrapper$queryPurchaseHistoryAsync$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Querying purchase history for type %s", Arrays.copyOf(new Object[]{this.$productType$inlined}, 1));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
