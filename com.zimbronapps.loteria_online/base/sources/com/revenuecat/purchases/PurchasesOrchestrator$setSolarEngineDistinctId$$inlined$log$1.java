...
public final class PurchasesOrchestrator$setSolarEngineDistinctId$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("%s called", Arrays.copyOf(new Object[]{"setSolarEngineDistinctId"}, 1));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
