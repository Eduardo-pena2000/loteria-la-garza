...
public final class PurchaseParamsValidator {
    ...
    private final Result validateAddOnProducts(PurchaseParams purchaseParams) {
        ...
        GooglePurchasingData.Subscription purchasingData$purchases_defaultsBc8Release = purchaseParams.getPurchasingData$purchases_defaultsBc8Release();
        GooglePurchasingData.Subscription subscription = purchasingData$purchases_defaultsBc8Release instanceof GooglePurchasingData.Subscription ? purchasingData$purchases_defaultsBc8Release : null;
        if (subscription == null || (addOnProducts = subscription.getAddOnProducts()) == null) {
            return new Result.Success(I.a);
        }
        if (!addOnProducts.isEmpty()) {
            ...
            if (iso8601 != null) {
                ...
                while (it2.hasNext()) {
                    if (!t.c(((Period) it2.next()).getIso8601(), iso8601)) {
        ...
        switch (LogWrapperKt.WhenMappings.$EnumSwitchMapping$0[logIntent.ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                LogWrapperKt.getCurrentLogHandler().e("[Purchases] - ERROR", (String) purchaseParamsValidator$validateAddOnProducts$$inlined$log$1.invoke(), (Throwable) null);
                break;
            case 3:
    ...
    public final Result validate(PurchaseParams purchaseParams) throws PurchasesException {
        t.g(purchaseParams, "purchaseParams");
        if (purchaseParams.getContainsAddOnItems$purchases_defaultsBc8Release()) {
            Result validateAddOnProducts = validateAddOnProducts(purchaseParams);
            if (validateAddOnProducts instanceof Result.Error) {
                return validateAddOnProducts;
            }
        }
        return new Result.Success(I.a);
    }
