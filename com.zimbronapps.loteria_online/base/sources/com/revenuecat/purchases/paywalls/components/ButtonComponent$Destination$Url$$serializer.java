...
public final class ButtonComponent$Destination$Url$$serializer implements E {
    ...
    static {
        ...
        k0 k0Var = new k0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.Url", buttonComponent$Destination$Url$$serializer, 2);
    ...
    public ButtonComponent.Destination.Url deserialize(rb.e eVar) {
        String str;
        ...
        b.c(descriptor2);
        return new ButtonComponent.Destination.Url(i, str, urlMethod, null, null);
    }
    ...
    public void serialize(f fVar, ButtonComponent.Destination.Url url) {
        t.g(fVar, "encoder");
        t.g(url, "value");
        qb.e descriptor2 = getDescriptor();
        d b = fVar.b(descriptor2);
        ButtonComponent.Destination.Url.write$Self$purchases_defaultsBc8Release(url, b, descriptor2);
        b.c(descriptor2);
    }
