...
public final class ButtonComponent$Destination$PrivacyPolicy$$serializer implements E {
    ...
    static {
        ...
        k0 k0Var = new k0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.PrivacyPolicy", buttonComponent$Destination$PrivacyPolicy$$serializer, 2);
    ...
    public ButtonComponent.Destination.PrivacyPolicy deserialize(rb.e eVar) {
        String str;
    ...
    public void serialize(f fVar, ButtonComponent.Destination.PrivacyPolicy privacyPolicy) {
        t.g(fVar, "encoder");
        t.g(privacyPolicy, "value");
        qb.e descriptor2 = getDescriptor();
        d b = fVar.b(descriptor2);
        ButtonComponent.Destination.PrivacyPolicy.write$Self$purchases_defaultsBc8Release(privacyPolicy, b, descriptor2);
        b.c(descriptor2);
    }
