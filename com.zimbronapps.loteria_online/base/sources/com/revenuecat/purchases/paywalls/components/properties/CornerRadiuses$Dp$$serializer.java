...
public final class CornerRadiuses$Dp$$serializer implements E {
    ...
    static {
        ...
        k0 k0Var = new k0("com.revenuecat.purchases.paywalls.components.properties.CornerRadiuses.Dp", cornerRadiuses$Dp$$serializer, 4);
    ...
    public CornerRadiuses.Dp deserialize(rb.e eVar) {
        int i;
        double d;
        double d2;
        double d3;
    ...
    public void serialize(f fVar, CornerRadiuses.Dp dp) {
        kotlin.jvm.internal.t.g(fVar, "encoder");
        kotlin.jvm.internal.t.g(dp, "value");
        qb.e descriptor2 = getDescriptor();
        d b = fVar.b(descriptor2);
        CornerRadiuses.Dp.write$Self$purchases_defaultsBc8Release(dp, b, descriptor2);
        b.c(descriptor2);
    }
