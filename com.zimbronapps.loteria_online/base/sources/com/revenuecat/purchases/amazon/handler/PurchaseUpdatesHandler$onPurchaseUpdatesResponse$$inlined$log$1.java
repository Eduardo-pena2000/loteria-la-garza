...
public final class PurchaseUpdatesHandler$onPurchaseUpdatesResponse$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Retrieved productData: %s", Arrays.copyOf(new Object[]{this.$response$inlined}, 1));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
