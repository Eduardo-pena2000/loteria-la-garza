...
public final class IdentityManager$aliasCurrentUserIdTo$2$1$invoke$lambda$1$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Successfully aliased old user ID %s to current user ID %s.", Arrays.copyOf(new Object[]{this.$oldAppUserID$inlined, this.$newAppUserID$inlined}, 2));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
