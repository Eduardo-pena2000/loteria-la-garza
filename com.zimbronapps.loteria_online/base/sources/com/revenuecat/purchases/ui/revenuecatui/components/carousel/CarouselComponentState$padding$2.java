...
public final class CarouselComponentState$padding$2 extends u implements a {
    ...
    public final L invoke() {
        ...
        return (access$getPresentedPartial == null || (partial = access$getPresentedPartial.getPartial()) == null || (padding = partial.getPadding()) == null || (paddingValues = PaddingKt.toPaddingValues(padding)) == null) ? CarouselComponentState.access$getStyle$p(this.this$0).getPadding() : paddingValues;
    }
}
