...
public final class TabsComponentState$background$2 extends u implements a {
    ...
    public final BackgroundStyles invoke() {
        ...
        return (access$getPresentedPartial == null || (backgroundStyles = access$getPresentedPartial.getBackgroundStyles()) == null) ? TabsComponentState.access$getStyle$p(this.this$0).getBackground() : backgroundStyles;
    }
}
