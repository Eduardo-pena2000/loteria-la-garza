...
public final class TimelineComponentState$ItemState$description$2 extends u implements a {
    ...
    public final TextComponentStyle invoke() {
        return TimelineComponentState.ItemState.access$getStyle$p(this.this$0).getDescription();
    }
}
