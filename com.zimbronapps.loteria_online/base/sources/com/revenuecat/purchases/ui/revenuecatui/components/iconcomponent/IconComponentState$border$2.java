...
public final class IconComponentState$border$2 extends u implements a {
    final /* synthetic */ IconComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IconComponentState$border$2(IconComponentState iconComponentState) {
        super(0);
    ...
    public final BorderStyles invoke() {
        ...
        if (access$getIconBackground != null) {
            return access$getIconBackground.getBorder();
        }
        return null;
    }
}
