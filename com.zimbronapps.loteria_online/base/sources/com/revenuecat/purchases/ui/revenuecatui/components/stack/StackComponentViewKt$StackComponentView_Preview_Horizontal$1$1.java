...
public final class StackComponentViewKt$StackComponentView_Preview_Horizontal$1$1 extends l implements p {
    ...
    public StackComponentViewKt$StackComponentView_Preview_Horizontal$1$1(e eVar) {
        super(2, eVar);
    }
    ...
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((StackComponentViewKt$StackComponentView_Preview_Horizontal$1$1) create(paywallAction, eVar)).invokeSuspend(I.a);
    }
