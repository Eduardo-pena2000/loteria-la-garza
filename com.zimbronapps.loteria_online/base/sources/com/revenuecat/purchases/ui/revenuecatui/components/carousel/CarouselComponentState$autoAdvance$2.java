...
public final class CarouselComponentState$autoAdvance$2 extends u implements a {
    final /* synthetic */ CarouselComponentState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CarouselComponentState$autoAdvance$2(CarouselComponentState carouselComponentState) {
        super(0);
    ...
    public final CarouselComponent.AutoAdvancePages invoke() {
        ...
        return (access$getPresentedPartial == null || (partial = access$getPresentedPartial.getPartial()) == null || (autoAdvance = partial.getAutoAdvance()) == null) ? CarouselComponentState.access$getStyle$p(this.this$0).getAutoAdvance() : autoAdvance;
    }
}
