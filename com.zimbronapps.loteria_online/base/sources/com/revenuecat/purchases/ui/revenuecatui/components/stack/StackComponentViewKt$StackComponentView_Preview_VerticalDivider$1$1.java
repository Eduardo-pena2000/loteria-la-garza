...
public final class StackComponentViewKt$StackComponentView_Preview_VerticalDivider$1$1 extends l implements p {
    int label;
    ...
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((StackComponentViewKt$StackComponentView_Preview_VerticalDivider$1$1) create(paywallAction, eVar)).invokeSuspend(I.a);
    }
