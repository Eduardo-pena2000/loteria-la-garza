...
public final class StackComponentViewKt$StackComponentView_Preview_Pill_EdgeToEdge_Badge$1$1 extends l implements p {
    int label;

    public StackComponentViewKt$StackComponentView_Preview_Pill_EdgeToEdge_Badge$1$1(e eVar) {
        super(2, eVar);
    }
    ...
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((StackComponentViewKt$StackComponentView_Preview_Pill_EdgeToEdge_Badge$1$1) create(paywallAction, eVar)).invokeSuspend(I.a);
    }
