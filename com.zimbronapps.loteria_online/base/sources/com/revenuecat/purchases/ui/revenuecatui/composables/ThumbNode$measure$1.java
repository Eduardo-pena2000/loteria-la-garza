...
public final class ThumbNode$measure$1 extends l implements p {
    ...
    public ThumbNode$measure$1(ThumbNode thumbNode, float f, e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(O o, e eVar) {
        return ((ThumbNode$measure$1) create(o, eVar)).invokeSuspend(I.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            t.b(obj);
            a access$getSizeAnim$p = ThumbNode.access$getSizeAnim$p(this.this$0);
            if (access$getSizeAnim$p != null) {
                Float c = b.c(this.$size);
                ...
                this.label = 1;
                obj = a.f(access$getSizeAnim$p, c, access$getSnapSpec$p, (Object) null, (Qa.l) null, this, 12, (Object) null);
                if (obj == f) {
                    return f;
                }
            }
