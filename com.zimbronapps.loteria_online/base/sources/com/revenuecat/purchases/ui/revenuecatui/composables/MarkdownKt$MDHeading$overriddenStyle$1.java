...
public final class MarkdownKt$MDHeading$overriddenStyle$1 extends u implements p {
    ...
    public MarkdownKt$MDHeading$overriddenStyle$1(j jVar, long j, Y0 y0, long j2, L l, d1.u uVar, l1.j jVar2, boolean z, boolean z2, boolean z3, e eVar, int i, int i2, int i3) {
        super(2);
        this.$heading = jVar;
        this.$color = j;
        this.$style = y0;
