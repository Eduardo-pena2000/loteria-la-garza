...
public final class CarouselComponentViewKt$CarouselComponentView_Preview$1$1 extends l implements p {
    ...
    public CarouselComponentViewKt$CarouselComponentView_Preview$1$1(e eVar) {
        super(2, eVar);
    }
    ...
    public final Object invoke(PaywallAction paywallAction, e eVar) {
        return ((CarouselComponentViewKt$CarouselComponentView_Preview$1$1) create(paywallAction, eVar)).invokeSuspend(I.a);
    }
