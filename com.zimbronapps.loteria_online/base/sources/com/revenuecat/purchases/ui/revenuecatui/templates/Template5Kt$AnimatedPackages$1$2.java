...
public final class Template5Kt$AnimatedPackages$1$2 extends u implements q {
    final /* synthetic */ PaywallState.Loaded.Legacy $state;
    final /* synthetic */ PaywallViewModel $viewModel;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Template5Kt$AnimatedPackages$1$2(PaywallState.Loaded.Legacy legacy, PaywallViewModel paywallViewModel) {
        super(3);
        this.$state = legacy;
    ...
    public final void invoke(f AnimatedVisibility, m mVar, int i) {
        ...
        if (w.L()) {
            w.U(-212619485, i, -1, "com.revenuecat.purchases.ui.revenuecatui.templates.AnimatedPackages.<anonymous>.<anonymous> (Template5.kt:350)");
        }
        c cVar = c.a;
        ...
        while (it.hasNext()) {
            Template5Kt.access$SelectPackageButton(oVar, legacy, (TemplateConfiguration.PackageInfo) it.next(), paywallViewModel, mVar, 6);
        }
        mVar.P();
        mVar.v();
        if (w.L()) {
