...
public final class SyncPurchasesHelper$syncPurchases$3$invoke$$inlined$log$1 extends u implements Qa.a {
    ...
    public final String invoke() {
        ...
        sb.append(' ');
        String format = String.format("Error syncing purchases. Error: %s", Arrays.copyOf(new Object[]{this.$it$inlined}, 1));
        t.f(format, "format(...)");
        sb.append(format);
        return sb.toString();
    }
