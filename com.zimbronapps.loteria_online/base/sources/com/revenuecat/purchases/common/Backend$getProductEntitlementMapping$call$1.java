...
public final class Backend$getProductEntitlementMapping$call$1 extends Dispatcher.AsyncCall {
    ...
    public Backend$getProductEntitlementMapping$call$1(Backend backend, Endpoint.GetProductEntitlementMapping getProductEntitlementMapping, String str) {
        this.this$0 = backend;
    ...
    public void onCompletion(HTTPResult hTTPResult) {
        ...
        synchronized (backend) {
            list = (List) backend.getProductEntitlementCallbacks().remove(str);
        }
        if (list != null) {
            for (q qVar : list) {
                l lVar = (l) qVar.a();
                ...
                if (BackendHelperKt.isSuccessful(hTTPResult)) {
                    try {
                        lVar.invoke(ProductEntitlementMapping.Companion.fromNetwork$purchases_defaultsBc8Release(hTTPResult.getBody(), hTTPResult));
