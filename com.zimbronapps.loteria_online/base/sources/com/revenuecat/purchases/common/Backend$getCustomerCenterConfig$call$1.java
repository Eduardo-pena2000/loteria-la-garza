...
public final class Backend$getCustomerCenterConfig$call$1 extends Dispatcher.AsyncCall {
    ...
    public Backend$getCustomerCenterConfig$call$1(Backend backend, Endpoint.GetCustomerCenterConfig getCustomerCenterConfig, String str) {
        this.this$0 = backend;
    ...
    public void onCompletion(HTTPResult hTTPResult) {
        ...
        synchronized (backend) {
            list = (List) backend.getCustomerCenterCallbacks().remove(str);
        }
        if (list != null) {
            for (q qVar : list) {
                l lVar = (l) qVar.a();
                ...
                if (BackendHelperKt.isSuccessful(hTTPResult)) {
                    try {
                        ...
                        lVar.invoke(((CustomerCenterRoot) json$purchases_defaultsBc8Release.d(CustomerCenterRoot.Companion.serializer(), payload)).getCustomerCenter());
                    } catch (j e) {
