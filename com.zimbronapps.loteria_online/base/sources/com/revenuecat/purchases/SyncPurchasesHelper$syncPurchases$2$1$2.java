...
public final class SyncPurchasesHelper$syncPurchases$2$1$2 extends u implements Qa.l {
    ...
    public SyncPurchasesHelper$syncPurchases$2$1$2(List list, StoreTransaction storeTransaction, StoreTransaction storeTransaction2, SyncPurchasesHelper syncPurchasesHelper, String str, boolean z, boolean z2, Qa.l lVar, Qa.l lVar2) {
        super(1);
        this.$errors = list;
    ...
    public final void invoke(PurchasesError purchasesError) {
        ...
        SyncPurchasesHelper$syncPurchases$2$1$2$invoke$$inlined$log$1 syncPurchasesHelper$syncPurchases$2$1$2$invoke$$inlined$log$1 = new SyncPurchasesHelper$syncPurchases$2$1$2$invoke$$inlined$log$1(logIntent, this.$purchase, purchasesError);
