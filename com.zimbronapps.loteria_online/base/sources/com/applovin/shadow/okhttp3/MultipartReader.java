...
public final class MultipartReader implements Closeable {
    ...
    public final class PartSource implements Source {
        ...
        public void close() {
            if (t.c(MultipartReader.access$getCurrentPart$p(MultipartReader.this), this)) {
        ...
        public long read(Buffer buffer, long j) {
            ...
            if (!timeout.hasDeadline()) {
                ...
                try {
                    long access$currentPartBytesRemaining = MultipartReader.access$currentPartBytesRemaining(multipartReader, j);
                    long read = access$currentPartBytesRemaining == 0 ? -1L : MultipartReader.access$getSource$p(multipartReader).read(buffer, access$currentPartBytesRemaining);
            ...
            try {
                long access$currentPartBytesRemaining2 = MultipartReader.access$currentPartBytesRemaining(multipartReader, j);
                long read2 = access$currentPartBytesRemaining2 == 0 ? -1L : MultipartReader.access$getSource$p(multipartReader).read(buffer, access$currentPartBytesRemaining2);
                timeout.timeout(timeoutNanos, timeUnit);
                if (timeout2.hasDeadline()) {
