...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        public long read(Buffer buffer, long j) {
            t.g(buffer, "sink");
            try {
                return Http1ExchangeCodec.access$getSource$p(Http1ExchangeCodec.this).read(buffer, j);
            } catch (IOException e) {
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j) {
            ...
            Http1ExchangeCodec.access$getSink$p(Http1ExchangeCodec.this).write(buffer, j);
            Http1ExchangeCodec.access$getSink$p(Http1ExchangeCodec.this).writeUtf8("\r\n");
        }
    }
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() {
            ...
            try {
                ...
                String obj = E.j1(Http1ExchangeCodec.access$getSource$p(this.this$0).readUtf8LineStrict()).toString();
                if (this.bytesRemainingInChunk < 0 || (obj.length() > 0 && !B.N(obj, ";", false, 2, (Object) null))) {
    ...
    private final boolean isChunked(Response response) {
        return B.z("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true);
    }
    ...
    private final boolean isChunked(Request request) {
        return B.z("chunked", request.header("Transfer-Encoding"), true);
    }
}
