...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t.h(charAt, 31) <= 0 || t.h(charAt, 127) >= 0 || E.e0(" #%/:?@[\\]", charAt, 0, false, 6, (Object) null) != -1) {
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public static final String toCanonicalHost(String str) {
        t.g(str, "<this>");
        if (!E.T(str, ":", false, 2, (Object) null)) {
            try {
        ...
        InetAddress decodeIpv6 = (B.N(str, "[", false, 2, (Object) null) && B.y(str, "]", false, 2, (Object) null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
        if (decodeIpv6 == null) {
            return null;
        }
