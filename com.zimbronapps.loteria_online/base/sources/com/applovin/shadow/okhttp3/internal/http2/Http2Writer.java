...
public final class Http2Writer implements Closeable {
    ...
    public final synchronized void headers(boolean z, int i, List list) throws IOException {
    ...
    public final synchronized void pushPromise(int i, int i2, List list) throws IOException {
