...
public final class Http2Stream {
    ...
    public final class FramingSource implements Source {
        ...
        public void close() throws IOException {
            ...
            synchronized (http2Stream) {
                ...
                t.e(http2Stream, "null cannot be cast to non-null type java.lang.Object");
                ...
                synchronized (http2Stream) {
                    ...
                    try {
                        ...
                        if (this.readBuffer.size() > j3) {
                            ...
                            if (th == null && readBytesTotal >= http2Stream.getConnection().getOkHttpSettings().getInitialWindowSize() / 2) {
                ...
                synchronized (http2Stream2) {
                    try {
                        if (this.closed) {
                            ...
                            if (z3) {
                                t.e(http2Stream2, "null cannot be cast to non-null type java.lang.Object");
    ...
    public final void writeHeaders(List list, boolean z, boolean z2) throws IOException {
        boolean z3;
    ...
    public final class FramingSink implements Sink {
        ...
        public /* synthetic */ FramingSink(Http2Stream http2Stream, boolean z, int i, k kVar) {
            this((i & 1) != 0 ? false : z);
        }
    }
}
