    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers headers) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                if (B.z(headers.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i2 < value.length()) {
                        ...
                        if (B.z(trimSubstring, "permessage-deflate", true)) {
                            if (z) {
                                z4 = true;
                            }
                            i2 = i3;
                            while (i2 < delimiterOffset$default) {
                                ...
                                String D0 = delimiterOffset3 < delimiterOffset2 ? E.D0(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2), "\"") : null;
                                i2 = delimiterOffset2 + 1;
                                if (B.z(trimSubstring2, "client_max_window_bits", true)) {
                                    if (num != null) {
                                        z4 = true;
                                    }
                                    num = D0 != null ? A.p(D0) : null;
                                    if (num == null) {
                                        z4 = true;
                                    }
                                } else if (B.z(trimSubstring2, "client_no_context_takeover", true)) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    if (D0 != null) {
                                    ...
                                    z2 = true;
                                } else if (B.z(trimSubstring2, "server_max_window_bits", true)) {
                                    if (num2 != null) {
                                        z4 = true;
                                    }
                                    num2 = D0 != null ? A.p(D0) : null;
                                    if (num2 == null) {
                                        z4 = true;
                                    }
                                } else if (B.z(trimSubstring2, "server_no_context_takeover", true)) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (D0 != null) {
