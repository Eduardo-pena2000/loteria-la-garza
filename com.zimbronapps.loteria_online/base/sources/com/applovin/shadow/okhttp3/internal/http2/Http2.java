...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            strArr[i] = B.G(Util.format("%8s", binaryString), ' ', '0', false, 4, (Object) null);
        }
        BINARY = strArr;
    ...
    public final String formatFlags(int i, int i2) {
        ...
        if (i != 2 && i != 3) {
            ...
            if (i != 7 && i != 8) {
                ...
                String str2 = str;
                return (i != 5 || (i2 & 4) == 0) ? (i != 0 || (i2 & 32) == 0) ? str2 : B.H(str2, "PRIORITY", "COMPRESSED", false, 4, (Object) null) : B.H(str2, "HEADERS", "PUSH_PROMISE", false, 4, (Object) null);
            }
        }
        return BINARY[i2];
    }
