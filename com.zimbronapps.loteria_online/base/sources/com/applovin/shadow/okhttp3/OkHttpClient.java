...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder -addInterceptor(l lVar) {
            t.g(lVar, "block");
            return addInterceptor(new OkHttpClient$Builder$addInterceptor$2(lVar));
        }

        public final Builder -addNetworkInterceptor(l lVar) {
            t.g(lVar, "block");
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            t.g(certificatePinner, "certificatePinner");
            if (!t.c(certificatePinner, this.certificatePinner)) {
        ...
        public final Builder connectionSpecs(List list) {
            ...
            if (!t.c(list, this.connectionSpecs)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder eventListenerFactory(EventListener.Factory factory) {
            t.g(factory, "eventListenerFactory");
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            t.g(hostnameVerifier, "hostnameVerifier");
            if (!t.c(hostnameVerifier, this.hostnameVerifier)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder protocols(List list) {
            ...
            t.e(O0, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Protocol?>");
            if (O0.contains((Object) null)) {
                throw new IllegalArgumentException("protocols must not contain null");
            }
            O0.remove(Protocol.SPDY_3);
            if (!t.c(O0, this.protocols)) {
                this.routeDatabase = null;
            }
            List unmodifiableList = Collections.unmodifiableList(O0);
            t.f(unmodifiableList, "unmodifiableList(protocolsCopy)");
            this.protocols = unmodifiableList;
            return this;
        }

        public final Builder proxy(Proxy proxy) {
            if (!t.c(proxy, this.proxy)) {
                this.routeDatabase = null;
            }
            this.proxy = proxy;
            return this;
        ...
        public final Builder proxyAuthenticator(Authenticator authenticator) {
            ...
            if (!t.c(authenticator, this.proxyAuthenticator)) {
                this.routeDatabase = null;
            }
            this.proxyAuthenticator = authenticator;
            return this;
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            if (!t.c(proxySelector, this.proxySelector)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!t.c(socketFactory, this.socketFactory)) {
                this.routeDatabase = null;
            }
            this.socketFactory = socketFactory;
            return this;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) {
            ...
            if (!t.c(sSLSocketFactory, this.sslSocketFactoryOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sSLSocketFactory;
        ...
        public final Builder callTimeout(Duration duration) {
            ...
            callTimeout(c.a(duration), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public final Builder connectTimeout(Duration duration) {
            t.g(duration, "duration");
            connectTimeout(c.a(duration), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public final Builder pingInterval(Duration duration) {
            t.g(duration, "duration");
            pingInterval(c.a(duration), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public final Builder readTimeout(Duration duration) {
            t.g(duration, "duration");
            readTimeout(c.a(duration), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public final Builder writeTimeout(Duration duration) {
            t.g(duration, "duration");
            writeTimeout(c.a(duration), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory, X509TrustManager x509TrustManager) {
            ...
            if (!t.c(sSLSocketFactory, this.sslSocketFactoryOrNull) || !t.c(x509TrustManager, this.x509TrustManagerOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sSLSocketFactory;
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            A.D(this.interceptors, okHttpClient.interceptors());
            A.D(this.networkInterceptors, okHttpClient.networkInterceptors());
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).isTls()) {
                    if (builder.getSslSocketFactoryOrNull$okhttp() != null) {
                        ...
                        t.d(x509TrustManagerOrNull$okhttp);
    ...
    private final void verifyClientState() {
        ...
        t.e(list, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
        if (list.contains((Object) null)) {
            throw new IllegalStateException(("Null interceptor: " + this.interceptors).toString());
        }
        List list2 = this.networkInterceptors;
        t.e(list2, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
        ...
        if (!t.c(this.certificatePinner, CertificatePinner.DEFAULT)) {
            throw new IllegalStateException("Check failed.");
        }
    }
