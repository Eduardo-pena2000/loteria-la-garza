...
public class MaxNativeAdViewBinder {
    ...
    public static class Builder {
        ...
        public MaxNativeAdViewBinder build() {
            return new MaxNativeAdViewBinder(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.j, this.h, this.i, this.k, this.l, this.m, this.n, null);
        }
    ...
    public /* synthetic */ MaxNativeAdViewBinder(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, String str, a aVar) {
        this(view, i, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, str);
    }
