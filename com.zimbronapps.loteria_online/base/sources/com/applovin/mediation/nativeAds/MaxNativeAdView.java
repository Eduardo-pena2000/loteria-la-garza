...
public class MaxNativeAdView extends FrameLayout {
    ...
    private com.applovin.impl.mediation.ads.b m;
    ...
    public class a implements ViewTreeObserver.OnPreDrawListener {
        ...
        public boolean onPreDraw() {
            ...
            layoutParams.height = this.b.getParent().getWidth();
    ...
    private static /* synthetic */ void a(MaxNativeAd maxNativeAd, View view) {
    ...
    public void onAttachedToWindow() {
        ...
        com.applovin.impl.mediation.ads.b bVar = this.m;
        if (bVar != null) {
            bVar.c();
        }
    ...
    public void render(d3 d3Var, a.a aVar, k kVar) {
        recycle();
        if (!d3Var.v0().get() || !d3Var.u0().get()) {
            this.m = new com.applovin.impl.mediation.ads.b(d3Var, this, aVar, kVar);
        }
        ...
        if (d3Var.w0() && nativeAd.isContainerClickable()) {
            ...
            setOnClickListener(new b(nativeAd));
        }
        kVar.O();
        if (o.a()) {
    ...
    private void b(MaxNativeAd maxNativeAd) {
        ...
        b();
        postDelayed(new com.applovin.mediation.nativeAds.a(this), 2000L);
    }
    ...
    public MaxNativeAdView(MaxNativeAd maxNativeAd, MaxNativeAdViewBinder maxNativeAdViewBinder, Context context) {
        ...
        if (view != null) {
            ...
            this.a = LayoutInflater.from(context).inflate(i, this, false);
        }
        addView(this.a);
        this.b = findViewById(maxNativeAdViewBinder.titleTextViewId);
        this.c = findViewById(maxNativeAdViewBinder.advertiserTextViewId);
        this.d = findViewById(maxNativeAdViewBinder.bodyTextViewId);
        this.e = findViewById(maxNativeAdViewBinder.callToActionButtonId);
        this.f = findViewById(maxNativeAdViewBinder.iconImageViewId);
        this.g = findViewById(maxNativeAdViewBinder.iconContentViewId);
        this.h = findViewById(maxNativeAdViewBinder.optionsContentViewGroupId);
        this.i = findViewById(maxNativeAdViewBinder.optionsContentFrameLayoutId);
        this.j = findViewById(maxNativeAdViewBinder.starRatingContentViewGroupId);
        this.k = findViewById(maxNativeAdViewBinder.mediaContentViewGroupId);
        this.l = findViewById(maxNativeAdViewBinder.mediaContentFrameLayoutId);
        if (maxNativeAd != null) {
            b(maxNativeAd);
        }
    }
    ...
    private void a(MaxNativeAd maxNativeAd) {
        ...
        if (viewGroup != null) {
            ...
            if (mediaView != null) {
                ViewGroup parent = mediaView.getParent();
                if (parent != null) {
                    parent.removeAllViews();
                }
                mediaView.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
        ...
        if (viewGroup2 != null) {
            ...
            if (optionsView != null) {
                ViewGroup parent2 = optionsView.getParent();
                if (parent2 != null) {
    ...
    private void b() {
        ViewGroup findViewById = findViewById(R.id.applovin_native_inner_parent_layout);
        if (findViewById == null) {
            return;
        }
        ViewTreeObserver viewTreeObserver = getViewTreeObserver();
        if (viewTreeObserver.isAlive()) {
            viewTreeObserver.addOnPreDrawListener(new a(new WeakReference(viewTreeObserver), findViewById));
        }
    }
}
