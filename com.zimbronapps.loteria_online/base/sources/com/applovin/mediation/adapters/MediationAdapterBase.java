...
public abstract class MediationAdapterBase implements MaxAdapter, MaxNativeAdAdapter, MaxInterstitialAdViewAdapter, MaxRewardedAdViewAdapter, MaxAppOpenAdapter {
    ...
    public class 1 implements Callable {
        ...
        public 1(String str, Resources resources) {
            this.val$imageUrl = str;
            this.val$resources = resources;
        }

        public Drawable call() throws Exception {
            InputStream openStream = new URL(this.val$imageUrl).openStream();
            BitmapDrawable bitmapDrawable = new BitmapDrawable(this.val$resources, BitmapFactory.decodeStream(openStream));
            openStream.close();
    ...
    public Future createDrawableFuture(String str, Resources resources) {
        return getCachingExecutorService().submit(new 1(str, resources));
    }
    ...
    public void showInterstitialAd(MaxAdapterResponseParameters maxAdapterResponseParameters, ViewGroup viewGroup, androidx.lifecycle.k kVar, Activity activity, MaxInterstitialAdapterListener maxInterstitialAdapterListener) {
    ...
    public void showRewardedAd(MaxAdapterResponseParameters maxAdapterResponseParameters, ViewGroup viewGroup, androidx.lifecycle.k kVar, Activity activity, MaxRewardedAdapterListener maxRewardedAdapterListener) {
