...
public abstract class AppLovinSdkInitializationConfiguration {
    ...
    public interface Builder {
        ...
        List getTestDeviceAdvertisingIds();

        boolean isExceptionHandlerEnabled();

        Builder setAdUnitIds(List list);
        ...
        Builder setTestDeviceAdvertisingIds(List list);
    }
    ...
    public abstract List getAdUnitIds();
    ...
    public abstract List getTestDeviceAdvertisingIds();
