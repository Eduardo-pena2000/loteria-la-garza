...
public final class AppLovinSdk {
    ...
    public List getAvailableMediatedNetworks() {
    ...
    public void reinitialize(Boolean bool, Boolean bool2) {
        ...
        if (bool != null) {
            this.coreSdk.O();
            if (o.a()) {
                this.coreSdk.O().d("AppLovinSdk", "Toggled 'huc' to " + bool);
            }
        ...
        if (bool2 != null) {
            this.coreSdk.O();
            if (o.a()) {
                this.coreSdk.O().d("AppLovinSdk", "Toggled 'dns' to " + bool2);
            }
    ...
    public void showMediationDebugger(Map map) {
        this.coreSdk.a(map);
    }
}
