...
public class JsonUtils {
    ...
    public static JSONObject deepCopy(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                ...
                o.l("JsonUtils", "Failed to copy over item for key '" + str + "' to JSONObject deep copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static List getIntegerList(JSONObject jSONObject, String str, List list) {
    ...
    public static List getStringList(JSONObject jSONObject, String str, List list) {
        JSONArray jSONArray = getJSONArray(jSONObject, str, null);
    ...
    public static List optList(JSONArray jSONArray, List list) {
        try {
    ...
    public static JSONObject shallowCopy(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                ...
                o.l("JsonUtils", "Failed to copy over item for key '" + str + "' to JSONObject copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static List toIntegerList(JSONArray jSONArray) {
    ...
    public static Map toStringMap(JSONObject jSONObject) throws JSONException {
    ...
    public static Map toStringObjectMap(JSONObject jSONObject) throws JSONException {
        HashMap hashMap = new HashMap();
        Iterator keys = jSONObject.keys();
        while (keys.hasNext()) {
            String str = (String) keys.next();
    ...
    public static Map tryToStringMap(JSONObject jSONObject) {
        HashMap hashMap = new HashMap();
        Iterator keys = jSONObject.keys();
        while (keys.hasNext()) {
            String str = (String) keys.next();
            try {
                Object a = a(jSONObject.get(str));
    ...
    public static Map toStringObjectMap(String str) {
        try {
            ...
            while (keys.hasNext()) {
                ...
                if (jSONObject.isNull(str)) {
                    ...
                    if (opt instanceof JSONObject) {
                        bundle.putBundle(str, toBundle((JSONObject) opt));
                        ...
                        if (jSONArray.length() == 0) {
                            ...
                            bundle.putParcelableArrayList(str, toBundle(jSONArray));
                        }
    ...
    public static ArrayList toBundle(JSONArray jSONArray) {
        if (jSONArray != null && jSONArray.length() != 0) {
            ArrayList arrayList = new ArrayList(jSONArray.length());
            for (int i = 0; i < jSONArray.length(); i++) {
