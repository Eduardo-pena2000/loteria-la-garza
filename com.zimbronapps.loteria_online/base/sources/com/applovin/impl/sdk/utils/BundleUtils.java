...
public class BundleUtils {
    ...
    public static void putCharSequenceArrayList(String str, ArrayList arrayList, Bundle bundle) {
        if (arrayList != null) {
    ...
    public static void putIntegerArrayList(String str, ArrayList arrayList, Bundle bundle) {
        if (arrayList != null) {
    ...
    public static void putStringArrayList(String str, ArrayList arrayList, Bundle bundle) {
        if (arrayList != null) {
    ...
    public static Map toStringMap(Bundle bundle) {
        if (bundle == null) {
