...
public class AppLovinStarRatingView extends View {
    ...
    private Path getStarPath(RectF rectF) {
        ...
        List starPointsOnACircle = getStarPointsOnACircle(pointF, (float) (rectF.width() * 0.5d), 4.712389f);
        PointF pointF2 = (PointF) starPointsOnACircle.get(0);
        List starPointsOnACircle2 = getStarPointsOnACircle(pointF, getDistanceBetweenPoints(pointF, getMidpointBetweenPoints(pointF2, (PointF) starPointsOnACircle.get(1))) - ((float) (getDistanceBetweenPoints(pointF2, r3) / Math.tan(0.9424778f))), 5.340708f);
        Path path = new Path();
        path.moveTo(pointF2.x, pointF2.y);
        for (int i = 0; i < 5; i++) {
            PointF pointF3 = (PointF) starPointsOnACircle.get(i);
            PointF pointF4 = (PointF) starPointsOnACircle2.get(i);
    ...
    private List getStarPointsOnACircle(PointF pointF, float f, float f2) {
