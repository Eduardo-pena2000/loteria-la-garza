...
public abstract class w3 {
    ...
    public static List a(com.applovin.impl.sdk.k kVar) {
        HashSet hashSet;
        ArrayList arrayList = new ArrayList(kVar.c(r3.m7));
        if (!((Boolean) kVar.a(r3.n7)).booleanValue()) {
            return arrayList;
        }
        synchronized (f) {
    ...
    public static Map c(com.applovin.impl.sdk.k kVar) {
        ...
        String emptyIfNull = StringUtils.emptyIfNull(kVar.w0().e());
    ...
    public static MaxAdapter a(String str, com.applovin.impl.sdk.k kVar) {
        ...
        if (MaxAdapter.class.isAssignableFrom(cls)) {
            return (MaxAdapter) cls.getConstructor(new Class[]{AppLovinSdk.class}).newInstance(new Object[]{kVar.y0()});
        }
        kVar.O();
        if (com.applovin.impl.sdk.o.a()) {
    ...
    public static AppLovinSdkUtils.Size b(int i, MaxAdFormat maxAdFormat, Context context) {
        try {
            L5.h hVar = L5.h.i;
            Method method = L5.h.class.getMethod("getCurrentOrientationAnchoredAdaptiveBannerAdSize", new Class[]{Context.class, Integer.TYPE});
            Method method2 = L5.h.class.getMethod("getWidth", (Class[]) null);
            Method method3 = L5.h.class.getMethod("getHeight", (Class[]) null);
            Object invoke = method.invoke((Object) null, new Object[]{context, Integer.valueOf(i)});
            AppLovinSdkUtils.Size size = new AppLovinSdkUtils.Size(((Integer) method2.invoke(invoke, (Object[]) null)).intValue(), ((Integer) method3.invoke(invoke, (Object[]) null)).intValue());
    ...
    public static AppLovinSdkUtils.Size a(int i, Context context) {
        ...
        AppLovinSdkUtils.Size size = new AppLovinSdkUtils.Size(i, Math.max(50, Math.min(round, Math.min(90, Math.round(AppLovinSdkUtils.pxToDp(context, o0.b(context).y) * 0.15f)))));
        g.put(Integer.valueOf(i), size);
        return size;
    }
    ...
    public static boolean a(JSONObject jSONObject, String str, com.applovin.impl.sdk.k kVar) {
        ...
        kVar.D().a(d2.S0, "invalid_or_disabled_ad_unit_id", (Map) CollectionUtils.hashMap("ad_unit_id", str), "invalid_or_disabled_ad_unit_id" + str);
        return true;
    }
    ...
    public static Map a(y2 y2Var, com.applovin.impl.sdk.k kVar) {
        ...
        hashMap.put("{CUID}", emptyIfNull);
        hashMap.put("{PLACEMENT}", StringUtils.emptyIfNull(y2Var.getPlacement()));
        hashMap.put("{CUSTOM_DATA}", StringUtils.emptyIfNull(y2Var.e()));
        hashMap.put("{CREATIVE_ID}", StringUtils.emptyIfNull(y2Var.getCreativeId()));
        return hashMap;
    }
}
