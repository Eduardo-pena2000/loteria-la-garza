...
public class x4 implements Comparable {
    ...
    private static final List c = Arrays.asList(new Class[]{Boolean.class, Float.class, Double.class, Integer.class, Long.class, String.class});
    ...
    static {
        ...
        A0 = a("axon_events", G3.a(",", new CharSequence[]{"rewarded_ad_opportunity", "ad_view", "ad_clicked", "page_view", "view_item", "add_to_cart", "begin_checkout", "purchase", "add_payment_info", "remove_from_cart", "view_cart", "wishlist_updated", "refund_requested", "financial_deposit", "financial_withdraw", "financial_transaction", "level_start", "level_complete", "level_fail", "virtual_resource_transaction", "tutorial_complete", "energy_depleted", "use_prop", "game_shop_enter", "generate_lead", "login", "sign_up", "search", "product_review", "app_open", "account_verification_start", "account_verification_complete", "order", "account_linked", "friend_invite", "gift_transaction", "group_joined", "chat_sent", "post_view", "post_created", "subscribe", "start_trial"}));
        ...
        o1 = a("viewability_adview_banner_min_width", 320);
        ...
        i4 = a("mps", "");
        j4 = a("mpsl", 3);
        k4 = a("mpis", "com.applovin,dalvik,java,android,com.android");
        l4 = a("cmps", bool);
        m4 = a("rmps", bool);
        ...
        P6 = a("nvelifapd", bool);
        Q6 = a("sufecfhrd", bool);
        R6 = a("ignored_auto_redirect_schemes", G3.a(",", new CharSequence[]{"about", "data", "file"}));
        S6 = a("esowod", bool);
        T6 = a("sswskan", bool);
        U6 = a("rfipt", bool);
