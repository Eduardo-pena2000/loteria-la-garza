...
public class d {
    ...
    public class a implements p5.b {
        ...
        public void a(JSONArray jSONArray) {
            ...
            v5 v5Var = new v5(this.d, jSONArray, this.e, d.a(d.this), this.f);
            if (((Boolean) d.a(d.this).a(r3.o8)).booleanValue()) {
                d.a(d.this).q0().a((i5) v5Var, d6.b.MEDIATION);
            } else {
                d.a(d.this).q0().a(v5Var);
            }
        }
    }
    ...
    public static class b implements a.a {
        ...
        public /* synthetic */ b(Map map, Map map2, Map map3, c cVar, MaxAdFormat maxAdFormat, long j, long j2, d dVar, com.applovin.impl.sdk.k kVar, Context context, a aVar) {
        ...
        public void onAdLoadFailed(String str, MaxError maxError) {
            ...
            if (this.a.a(r3.i8, this.e) && c.d(this.d) < this.i && !z) {
                ...
                AppLovinSdkUtils.runOnUiThreadDelayed(new t(this, pow, str), TimeUnit.SECONDS.toMillis(pow));
                return;
            }
            c.a(this.d, 0);
        ...
        public void onAdLoaded(MaxAd maxAd) {
            ...
            d.a(this.c, maxAd.getAdUnitId(), maxAd.getFormat(), this.f, this.g, this.h, context2, this);
        }
        ...
        private b(Map map, Map map2, Map map3, c cVar, MaxAdFormat maxAdFormat, long j, long j2, d dVar, com.applovin.impl.sdk.k kVar, Context context) {
            this.a = kVar;
        ...
        private /* synthetic */ void a(int i, String str) {
            ...
            this.k = System.currentTimeMillis();
            d.a(this.c, str, this.e, this.f, this.g, this.h, context2, this);
        }
    }
    ...
    public static /* synthetic */ void a(d dVar, String str, MaxAdFormat maxAdFormat, Map map, Map map2, Map map3, Context context, a.a aVar) {
        dVar.a(str, maxAdFormat, map, map2, map3, context, aVar);
    }
    ...
    public static /* synthetic */ void a(d dVar, y2 y2Var) {
        dVar.a(y2Var);
    }
    ...
    public void a(String str, String str2, MaxAdFormat maxAdFormat, com.applovin.impl.i iVar, Map map, Map map2, Context context, a.a aVar) {
        y2 e = (this.a.s0().d() || n7.h(com.applovin.impl.sdk.k.o())) ? null : e(str);
        if (e != null) {
            e.i(str2);
            e.A().c().a(aVar);
            aVar.onAdLoaded(e);
            if (e.O().endsWith("load")) {
                aVar.onAdRevenuePaid(e);
            }
