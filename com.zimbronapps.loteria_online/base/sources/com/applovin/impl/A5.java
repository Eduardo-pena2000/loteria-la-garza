...
public final class a5 {
    ...
    public a5(com.applovin.impl.sdk.k kVar) {
        this.a = com.applovin.impl.sdk.k.o().getSharedPreferences("com.applovin.sdk.preferences." + kVar.i0(), 0);
        b = kVar;
    }
    ...
    public void b(z4 z4Var) {
        a(this.a.edit().remove(z4Var.a()));
    }

    public Object a(z4 z4Var, Object obj) {
        return a(z4Var, obj, this.a);
    }
    ...
    public static Object a(z4 z4Var, Object obj, SharedPreferences sharedPreferences, boolean z) {
        return a(z4Var.a(), obj, z4Var.b(), sharedPreferences, z);
    }
        ...
        try {
            if (n7.i()) {
                ...
                if (kVar != null && kVar.q0() != null) {
                    ...
                    q0.a((i5) new r6(kVar2, true, "commitSharedPreferencesChanges", new M(editor)), d6.b.e);
                } else {
                    editor.apply();
                }
            } else {
            ...
            try {
                b.D().c("SharedPreferencesManager", "persistChanges", th);
