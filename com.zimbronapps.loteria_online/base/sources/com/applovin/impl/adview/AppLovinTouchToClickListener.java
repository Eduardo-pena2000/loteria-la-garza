...
public class AppLovinTouchToClickListener implements View.OnTouchListener {
    ...
    public AppLovinTouchToClickListener(com.applovin.impl.sdk.k kVar, x4 x4Var, Context context, OnClickListener onClickListener) {
        this.a = ((Long) kVar.a(x4.c0)).longValue();
        this.b = ((Integer) kVar.a(x4.d0)).intValue();
        this.c = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.h0)).intValue());
        this.d = ClickRecognitionState.values()[((Integer) kVar.a(x4Var)).intValue()];
        this.h = context;
