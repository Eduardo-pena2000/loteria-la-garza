...
public class g3 extends s2 {
    ...
    private List j() {
        ...
        if (StringUtils.isValidString(this.e.v())) {
            arrayList.add(r2.a(r2.c.e).d(this.e.v()).a());
        }
    ...
    private r2 a(String str, String str2, boolean z, boolean z2) {
        return r2.a(z ? r2.c.f : r2.c.e).d(str).a(z ? null : this.k).b("Instructions").a(str2).a(z ? R.drawable.applovin_ic_check_mark_bordered : c(z2)).b(z ? m0.a(R.color.applovin_sdk_checkmarkColor, this.a) : d(z2)).a(!z).a();
    }
