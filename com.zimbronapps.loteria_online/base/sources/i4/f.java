...
public class f {
    ...
    public static f a(m4.b bVar, String str) {
        return new f(str, b(bVar, str), d(bVar, str), f(bVar, str));
    }

    public static Map b(m4.b bVar, String str) {
    ...
    public static Set d(m4.b bVar, String str) {
        HashSet hashSet = new HashSet();
        Cursor f1 = bVar.f1("PRAGMA foreign_key_list(`" + str + "`)");
        try {
    ...
    public static d e(m4.b bVar, String str, boolean z) {
        Cursor f1 = bVar.f1("PRAGMA index_xinfo(`" + str + "`)");
        try {
    ...
    public static Set f(m4.b bVar, String str) {
        Cursor f1 = bVar.f1("PRAGMA index_list(`" + str + "`)");
        try {
            int columnIndex = f1.getColumnIndex("name");
