...
public final class g extends h {
    ...
    public static final class b {
        ...
        public b a(q qVar) {
            return new b(this.a, qVar, this.c, this.d, this.e, this.f);
        }
    }

    public g(String str, List list, List list2, List list3, List list4, List list5, List list6, q qVar, List list7, boolean z, Map map, List list8) {
        super(str, list, z);
    ...
    public g a(List list) {
        return new g(this.a, this.b, d(this.e, 0, list), Collections.emptyList(), d(this.g, 1, list), d(this.h, 2, list), Collections.emptyList(), this.j, this.k, this.c, this.l, this.m);
    }
}
