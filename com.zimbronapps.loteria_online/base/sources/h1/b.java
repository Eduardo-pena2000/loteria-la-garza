...
public abstract class b extends ContentProvider {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    ...
                    File[] externalCacheDirs = H1.a.getExternalCacheDirs(context);
    ...
    public final b f() {
        ...
        synchronized (this.a) {
            try {
                S1.c.d(this.b, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
                if (this.c == null) {
