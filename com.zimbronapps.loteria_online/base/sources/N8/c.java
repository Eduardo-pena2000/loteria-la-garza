...
public class c {
    ...
    public final File a() {
        if (this.a == null) {
            synchronized (this) {
                try {
                    if (this.a == null) {
                        this.a = new File(this.b.m().getFilesDir(), "PersistedInstallation." + this.b.s() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        ...
        try {
            ...
            createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.b.m().getFilesDir());
