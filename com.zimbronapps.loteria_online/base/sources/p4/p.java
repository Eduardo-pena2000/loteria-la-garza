...
public final class p {
    public static final String s = G4.m.f("WorkSpec");
    public static final t.a t = new a();
    public String a;
    public G4.v b;
    public String c;
    public String d;
    ...
    public p(String str, String str2) {
        this.b = G4.v.ENQUEUED;
        androidx.work.b bVar = androidx.work.b.c;
        this.e = bVar;
        this.f = bVar;
        this.j = G4.b.i;
        this.l = G4.a.EXPONENTIAL;
        this.m = 30000L;
        this.p = -1L;
        this.r = G4.q.RUN_AS_NON_EXPEDITED_WORK_REQUEST;
        this.a = str;
        this.c = str2;
    }
    ...
    public long a() {
        if (c()) {
            return this.n + Math.min(18000000L, this.l == G4.a.LINEAR ? this.m * this.k : (long) Math.scalb(this.m, this.k - 1));
        }
        if (!d()) {
            long j = this.n;
            if (j == 0) {
    ...
    public boolean b() {
        return !G4.b.i.equals(this.j);
    }

    public boolean c() {
        return this.b == G4.v.ENQUEUED && this.k > 0;
    }
