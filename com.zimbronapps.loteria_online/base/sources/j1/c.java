...
public abstract class c {
    ...
    public static ColorStateList e(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray h = h(resources2, theme, attributeSet, F1.d.b);
                int resourceId = h.getResourceId(F1.d.c, -1);
                if (resourceId == -1 || f(resources2, resourceId)) {
                    color = h.getColor(F1.d.c, -65281);
                } else {
                    try {
                ...
                float f = 1.0f;
                if (h.hasValue(F1.d.d)) {
                    f = h.getFloat(F1.d.d, 1.0f);
                } else if (h.hasValue(F1.d.f)) {
                    f = h.getFloat(F1.d.f, 1.0f);
                }
                float f2 = (Build.VERSION.SDK_INT < 31 || !h.hasValue(F1.d.e)) ? h.getFloat(F1.d.g, -1.0f) : h.getFloat(F1.d.e, -1.0f);
                h.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != F1.a.a && attributeNameResource != F1.a.b) {
                        int i5 = i3 + 1;
                ...
                iArr2 = g.a(iArr2, i2, g(color, f, f2));
                iArr = (int[][]) g.b(iArr, i2, trimStateSet);
                i2++;
            }
            i = 1;
    ...
    public static int g(int i, float f, float f2) {
        ...
        int a2 = N1.a.a((int) ((Color.alpha(i) * f) + 0.5f), 0, 255);
        if (z) {
            a c = a.c(i);
            i = a.m(c.j(), c.i(), f2);
        }
