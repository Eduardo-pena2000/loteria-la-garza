...
public abstract class h {
    ...
    public static final class d {
        ...
        public boolean equals(Object obj) {
            ...
            d dVar = (d) obj;
            return this.a.equals(dVar.a) && S1.c.a(this.b, dVar.b);
        }

        public int hashCode() {
            return S1.c.b(this.a, this.b);
        }
    }
        ...
        public static class a {
            ...
            */
            public static void a(android.content.res.Resources.Theme r6) {
                /*
                    java.lang.Object r0 = J1.h.f.a.a
                    monitor-enter(r0)
                    boolean r1 = J1.h.f.a.c     // Catch: java.lang.Throwable -> L17
                    r2 = 0
                    if (r1 != 0) goto L23
                    r1 = 1
                    ...
                    J1.h.f.a.b = r3     // Catch: java.lang.Throwable -> L17 java.lang.NoSuchMethodException -> L19
                ...
                L21:
                    J1.h.f.a.c = r1     // Catch: java.lang.Throwable -> L17
                L23:
                    java.lang.reflect.Method r1 = J1.h.f.a.b     // Catch: java.lang.Throwable -> L17
                    if (r1 == 0) goto L37
                ...
                L2e:
                    ...
                    J1.h.f.a.b = r2     // Catch: java.lang.Throwable -> L17
                L37:
                ...
                L39:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: J1.h.f.a.a(android.content.res.Resources$Theme):void");
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.content.res.ColorStateList b(J1.h.d r5, int r6) {
        /*
            java.lang.Object r0 = J1.h.c
            monitor-enter(r0)
            java.util.WeakHashMap r1 = J1.h.b     // Catch: java.lang.Throwable -> L32
            ...
            J1.h$c r2 = (J1.h.c) r2     // Catch: java.lang.Throwable -> L32
            if (r2 == 0) goto L45
        ...
        L48:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: J1.h.b(J1.h$d, int):android.content.res.ColorStateList");
    }
    ...
    public static Typeface g(Context context, int i, TypedValue typedValue, int i2, e eVar) {
        if (context.isRestricted()) {
            return null;
        }
        return l(context, i, typedValue, i2, eVar, null, true, false);
    }

    public static void h(Context context, int i, e eVar, Handler handler) {
        S1.g.h(eVar);
        if (context.isRestricted()) {
            eVar.c(-4, handler);
        } else {
            l(context, i, new TypedValue(), 0, eVar, handler, false, false);
        }
    }
    ...
    public static ColorStateList j(Resources resources, int i, Resources.Theme theme) {
        ...
        try {
            return J1.c.a(resources, resources.getXml(i), theme);
        } catch (Exception e2) {
    ...
    public static Typeface l(Context context, int i, TypedValue typedValue, int i2, e eVar, Handler handler, boolean z, boolean z2) {
        Resources resources = context.getResources();
        resources.getValue(i, typedValue, true);
        Typeface m = m(context, resources, typedValue, i, i2, eVar, handler, z, z2);
        if (m != null || eVar != null || z2) {
            return m;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.graphics.Typeface m(android.content.Context r16, android.content.res.Resources r17, android.util.TypedValue r18, int r19, int r20, J1.h.e r21, android.os.Handler r22, boolean r23, boolean r24) {
        /*
            Method dump skipped, instructions count: 245
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: J1.h.m(android.content.Context, android.content.res.Resources, android.util.TypedValue, int, int, J1.h$e, android.os.Handler, boolean, boolean):android.graphics.Typeface");
    }
}
