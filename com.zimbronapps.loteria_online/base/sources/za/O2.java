...
public abstract class o2 {
    ...
    public abstract String b(t4.g gVar);

    public abstract long c(t4.g gVar);

    public P d() {
        return this.a;
    }

    public final void e(t4.g pigeon_instanceArg, Qa.l callback) {
        ...
        if (d().c()) {
            ...
            new da.a(d().a(), "dev.flutter.pigeon.webview_flutter_android.WebResourceErrorCompat.pigeon_newInstance", d().b()).d(Da.v.q(Long.valueOf(c), Long.valueOf(c2), b(pigeon_instanceArg)), new n2(callback, "dev.flutter.pigeon.webview_flutter_android.WebResourceErrorCompat.pigeon_newInstance"));
        }
    }
}
