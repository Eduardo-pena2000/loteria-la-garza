...
public abstract class p {
        ...
        public static final class a implements fb.f {
            ...
            public final Object emit(j jVar, Ga.e eVar) {
                if (jVar instanceof o.b) {
                    ...
                    this.a.remove(((o.c) jVar).a());
                } else if (jVar instanceof o.a) {
                    this.a.remove(((o.a) jVar).a());
                }
    ...
    public static final h2 a(k kVar, b0.m mVar, int i) {
        if (w.L()) {
            w.U(-1692965168, i, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
        Object C = mVar.C();
        m.a aVar = b0.m.a;
        if (C == aVar.a()) {
