...
public abstract class a {
    ...
    public static void j(l lVar, b bVar) {
        if (k()) {
            ...
            lVar.n(new d(null), new c(bVar), 1);
        }
    }
    ...
    public static final class c implements l.b {
        ...
        public void i(l.e eVar, long j, long j2) {
            if (this.a != null) {
                if (a.k()) {
                    this.a.b();
                } else {
        ...
        public l.c o(l.e eVar, long j, long j2, IOException iOException, int i) {
            b bVar = this.a;
            if (bVar != null) {
                bVar.a(iOException);
            }
        ...
        public void k(l.e eVar, long j, long j2, boolean z) {
        }
    }
}
